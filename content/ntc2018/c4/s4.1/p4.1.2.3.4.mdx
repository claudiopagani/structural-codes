---
id: ntc2018:c4/s4.1/p4.1.2.3.4
slug: ntc2018-c4-s4-1-p4-1-2-3-4
kind: paragraph
numbering: "4.1.2.3.4"
...
refsOut:
  - targetId: "ntc2018:c4/s4.1/p4.1.2.3.4.1"
    scope: internal
    rawText: "ipotesi di base"
  - targetId: "ntc2018:c4/s4.1/p4.1.2.3.4.2"
    scope: internal
    rawText: "verifiche di resistenza e duttilità"
workflow:
  status: converted
