---
id: ntc2018:c3/s3.4/p3.4.4
slug: ntc2018-c3-s3-4-p3-4-4
kind: paragraph
numbering: "3.4.4"
...
Il coefficiente di esposizione CE tiene conto delle caratteristiche specifiche dell'area in cui sorge l'opera. Valori consigliati di questo coefficiente sono forniti in Tab. 3.4.I per diverse classi di esposizione. Se non diversamente indicato, si assumerà CE = 1.
</OfficialText>

<NormativeTable id="ntc2018:c3/s3.4/tab3.4.i" />
