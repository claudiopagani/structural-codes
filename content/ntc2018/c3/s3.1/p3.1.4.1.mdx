---
id: ntc2018:c3/s3.1/p3.1.4.1
slug: ntc2018-c3-s3-1-p3-1-4-1
kind: paragraph
numbering: "3.1.4.1"
...
openIssues:
  - marker: "TABELLA_DA_REVISIONARE"
    note: "Tab. 3.1.II (sovraccarichi cat. A-K) da strutturare."
---

<OfficialText hash="[DA_VERIFICARE]">
3.1.4.1 SOVRACCARICHI VERTICALI UNIFORMEMENTE DISTRIBUITI

[DA_VERIFICARE: contenuto e Tab. 3.1.II da estrarre dal PDF NTC]
</OfficialText>
