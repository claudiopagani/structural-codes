---
id: ntc2018:c3/s3.2/p3.2.1
slug: ntc2018-c3-s3-2-p3-2-1
kind: paragraph
numbering: "3.2.1"
...
openIssues:
  - marker: "TABELLA_DA_REVISIONARE"
    note: "Tab. 3.2.I (PVR per stati limite) da strutturare."
---

<OfficialText hash="[DA_VERIFICARE]">
3.2.1. STATI LIMITE E RELATIVE PROBABILITÀ DI SUPERAMENTO

[DA_VERIFICARE: contenuto e Tab. 3.2.I da estrarre dal PDF NTC]
</OfficialText>
