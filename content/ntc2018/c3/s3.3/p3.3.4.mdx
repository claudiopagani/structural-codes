---
id: ntc2018:c3/s3.3/p3.3.4
slug: ntc2018-c3-s3-3-p3-3-4
kind: paragraph
numbering: "3.3.4"
...
refsOut:
  ...
  - { targetId: "ntc2018:c3/s3.3/p3.3.9", scope: "explicit", rawText: "§ 3.3.9" }
workflow:
  status: converted
...
openIssues:
  - marker: "DA_VERIFICARE"
    note: "Refuso: '33.3.4.' con doppia cifra."
---

<OfficialText hash="[DA_VERIFICARE]">
33.3.4. PRESSIONE DEL VENTO

La pressione del vento è data dall'espressione:
</OfficialText>

<Formula id="ntc2018:c3/s3.3/eq3.3.4" number="3.3.4" latex="p = q_r \cdot c_e \cdot c_p \cdot c_d" />
