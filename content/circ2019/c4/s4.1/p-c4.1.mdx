...
relations:
  - { type: "clarifies", targetId: "ntc2018:c4/s4.1/p4.1", note: "La Circolare C4.1 commenta e integra le disposizioni NTC §4.1 (p4.1)" }
source:
...
figures: []
refsOut:
  - { targetId: "ntc2018:c4/s4.1/p4.1", scope: "explicit", rawText: "§ 4.1.1.1 delle NTC" }
