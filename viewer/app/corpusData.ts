...
export function loadManifest() {
  return fetchJson<CorpusManifest>("/data/codes/manifest.json");
}

export function loadDocumentIndex(manifest: CorpusManifest, document: DocumentId) {
  return fetchJson<DocumentIndex>(manifest.documents[document].indexPath);
}

export function loadChunk(path: string) {
  return fetchJson<CorpusChunk>(path);
}

export function loadRelations(manifest: CorpusManifest) {
  return fetchJson<RelationsIndex>(manifest.relationsPath);
}

export function loadSearchIndex(manifest: CorpusManifest) {
  return fetchJson<SearchIndex>(manifest.searchIndexPath);
}
