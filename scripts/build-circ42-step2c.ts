...
const formulaRows: FormulaRow[] = [
    { number: "C4.2.43", officialNumber: "C4.2.43", unit: "C4.2.4.1.3.4.1", page: 113, latex: "\\frac{h_w}{t}\\ge\\frac{72}{\\eta}\\cdot\\varepsilon", raw: "h_w/t ≥ 72/η · ε [C4.2.43]", region: reg(145, 130, 310, 55) },
    { number: "C4.2.44", officialNumber: "C4.2.44", unit: "C4.2.4.1.3.4.1", page: 113, latex: "\\frac{h_w}{t}\\ge\\frac{31}{\\eta}\\cdot\\varepsilon\\cdot\\sqrt{k_\\tau}", raw: "h_w/t ≥ 31/η · ε · √k_τ [C4.2.44]", region: reg(145, 205, 310, 55) },
    ...
    { number: "C4.2.46", officialNumber: "C4.2.46", unit: "C4.2.4.1.3.4.1", page: 113, latex: "V_{b,Rd}=V_{bw,Rd}+V_{bf,Rd}\\le\\frac{\\eta\\cdot f_{yw}\\cdot h_w\\cdot t}{\\sqrt{3}\\cdot\\gamma_{M1}}", raw: "V_b,Rd = V_bw,Rd + V_bf,Rd ≤ η · f_yw · h_w · t/(√3 · γ_M1) [C4.2.46]", region: reg(125, 350, 340, 70) },
    { number: "C4.2.47", officialNumber: "C4.2.47", unit: "C4.2.4.1.3.4.1", page: 113, latex: "V_{bw,Rd}=\\frac{\\chi_w\\cdot f_{yw}\\cdot h_w\\cdot t}{\\sqrt{3}\\cdot\\gamma_{M1}}", raw: "V_bw,Rd = χ_w · f_yw · h_w · t/(√3 · γ_M1) [C4.2.47]", region: reg(145, 475, 310, 60) },
    { number: "C4.2.48", officialNumber: "C4.2.48", unit: "C4.2.4.1.3.4.1", page: 113, latex: "V_{bf,Rd}=\\frac{b_f\\cdot t_f^2\\cdot f_{yf}}{a\\left(0{,}25+\\frac{1{,}6\\cdot b_f\\cdot t_f^2\\cdot f_{yf}}{t\\cdot h_w^2\\cdot f_{yw}}\\right)\\gamma_{M1}}\\cdot\\left[1-\\left(\\frac{M_{Ed}}{M_{f,red}}\\right)^2\\right]", raw: "V_bf,Rd = [b_f · t_f² · f_yf / (a(0,25 + 1,6 · b_f · t_f² · f_yf/(t · h_w² · f_yw))γ_M1)] · [1 − (M_Ed/M_f,red)²] [C4.2.48]", region: reg(90, 535, 415, 105) },
    { number: "C4.2.49", officialNumber: "C4.2.49", unit: "C4.2.4.1.3.4.1", page: 113, latex: "M_{f,red}=\\frac{M_{fk}}{\\gamma_{M0}}\\cdot\\left(1-\\frac{N_{Ed}\\cdot\\gamma_{M0}}{(A_{fi}+A_{fs})\\cdot f_{yf}}\\right)", raw: "M_f,red = M_fk/γ_M0 · (1 − N_Ed · γ_M0/((A_fi + A_fs) · f_yf)) [C4.2.49]", region: reg(135, 650, 350, 65) },
    ...
    { number: "C4.2.4.1.3.4.1-sigma-e", officialNumber: null, unit: "C4.2.4.1.3.4.1", page: 114, latex: "\\sigma_E=\\frac{\\pi^2\\cdot E\\cdot t^2}{12(1-\\nu^2)\\cdot h_w^2}=190000\\left(\\frac{t}{h_w}\\right)^2\\,[\\mathrm{MPa}]", raw: "σ_E = π² · E · t²/[12(1 − ν²) · h_w²] = 190000(t/h_w)² [MPa]", region: reg(115, 145, 380, 70) },
    ...
    { number: "C4.2.52", officialNumber: "C4.2.52", unit: "C4.2.4.1.3.4.1", page: 114, latex: "\\begin{aligned}I_{st}&\\ge1{,}5\\cdot h_w^3\\cdot t^3/a^2 &&\\text{se } a/h_w<\\sqrt{2}\\\\I_{st}&\\ge0{,}75\\cdot h_w\\cdot t^3 &&\\text{se } a/h_w\\ge\\sqrt{2}\\end{aligned}", raw: "I_st ≥ 1,5 · h_w³ · t³/a² se a/h_w < √2; I_st ≥ 0,75 · h_w · t³ se a/h_w ≥ √2 [C4.2.52]", region: reg(125, 320, 355, 85) },
    { number: "C4.2.53", officialNumber: "C4.2.53", unit: "C4.2.4.1.3.4.1", page: 114, latex: "N_{st,d}=V_{Ed}-\\frac{f_{yw}\\cdot h_w\\cdot t}{\\sqrt{3}\\cdot\\lambda_w^2\\cdot\\gamma_{M1}}", raw: "N_st,d = V_Ed − f_yw · h_w · t/(√3 · λ_w² · γ_M1) [C4.2.53]", region: reg(145, 415, 315, 60) },
    ...
    { number: "C4.2.55", officialNumber: "C4.2.55", unit: "C4.2.4.1.3.4.1", page: 114, latex: "k_{\\tau l}=\\max\\left[\\left(\\frac{3}{\\alpha}\\right)^2\\cdot\\sqrt[4]{\\left(\\frac{I_{sl}}{t^3\\cdot h_w}\\right)^3};\\frac{2{,}1}{t}\\cdot\\sqrt[3]{\\frac{I_{sl}}{h_w}}\\right]", raw: "k_τl = max[(3/α)² · ⁴√((I_sl/(t³ · h_w))³); (2,1/t) · ³√(I_sl/h_w)] [C4.2.55]", region: reg(105, 585, 390, 75) },
    { number: "C4.2.56", officialNumber: "C4.2.56", unit: "C4.2.4.1.3.4.1", page: 114, latex: "k_\\tau=4{,}1+\\frac{1}{\\alpha^2}\\cdot\\left(6{,}3+0{,}18\\cdot\\frac{I_{sl}}{t^3\\cdot h_w}\\right)+2{,}2\\cdot\\sqrt[3]{\\frac{I_{sl}}{t^3\\cdot h_w}}", raw: "k_τ = 4,1 + 1/α² · (6,3 + 0,18 · I_sl/(t³ · h_w)) + 2,2 · ³√(I_sl/(t³ · h_w)) [C4.2.56]", region: reg(105, 660, 390, 70) },
];
...
const units = [
    ...
    makeUnit("C4.2.4.1.3.4.1", "Stabilità dei pannelli soggetti a taglio", [
        ...
        block("C4.2.4.1.3.4.1", "p17", "paragraph", 114, "essendo V_Ed è il taglio di calcolo a distanza 0,5·h_w dal bordo del pannello più sollecitato.", [text("essendo "), math("V_Ed", "V_{Ed}"), text(" è il taglio di calcolo a distanza "), math("0,5·h_w", "0{,}5\\cdot h_w"), text(" dal bordo del pannello più sollecitato.")]),
