...
const tableIV = {
    ...
    rows: [
        ...
        [
            ...
            { text: "c/t ≤ 9ε/α", latex: "c/t\\le9\\varepsilon/\\alpha", colSpan: 2 },
        ...
        [
            ...
            { text: "c/t ≤ 10ε/α", latex: "c/t\\le10\\varepsilon/\\alpha", colSpan: 2 },
...
const units = [
    makeUnit("4.2.3", "ANALISI STRUTTURALE", [
        ...
        textBlock("4.2.3.1", "editorial-005", "paragraph", { ...p98, wrap: true }, region(82.954, 121.614, 428.696, 27.617), "classe 1 se la sezione è in grado di sviluppare una cerniera plastica avente la capacità rotazionale richiesta per l’analisi strutturale\ncondotta con il metodo plastico di cui al § 4.2.3.2 senza subire riduzioni della resistenza Possono generalmente classifi-\ncarsi come tali le sezioni con capacità rotazionale CΟ ǃ 3;", "classe 1 se la sezione è in grado di sviluppare una cerniera plastica avente la capacità rotazionale richiesta per l’analisi strutturale condotta con il metodo plastico di cui al § 4.2.3.2 senza subire riduzioni della resistenza Possono generalmente classificarsi come tali le sezioni con capacità rotazionale Cφ ≥ 3;", [text("classe 1 se la sezione è in grado di sviluppare una cerniera plastica avente la capacità rotazionale richiesta per l’analisi strutturale condotta con il metodo plastico di cui al § 4.2.3.2 senza subire riduzioni della resistenza Possono generalmente classificarsi come tali le sezioni con capacità rotazionale "), math("Cφ ≥ 3", "C_{\\varphi}\\ge3"), text(";")]),
        textBlock("4.2.3.1", "editorial-006", "paragraph", { ...p98, wrap: true }, region(82.954, 155.254, 428.56, 17.552), "classe 2 se la sezione è in grado di sviluppare il proprio momento resistente plastico, ma con capacità rotazionale limitata. Possono\ngeneralmente classificarsi come tali le sezioni con capacità rotazionale CΟ ǃ 1,5;", "classe 2 se la sezione è in grado di sviluppare il proprio momento resistente plastico, ma con capacità rotazionale limitata. Possono generalmente classificarsi come tali le sezioni con capacità rotazionale Cφ ≥ 1,5;", [text("classe 2 se la sezione è in grado di sviluppare il proprio momento resistente plastico, ma con capacità rotazionale limitata. Possono generalmente classificarsi come tali le sezioni con capacità rotazionale "), math("Cφ ≥ 1,5", "C_{\\varphi}\\ge1{,}5"), text(";")]),
...
const manifest = {
    ...
    formulas: [
        { id: f420, unitId: unitId("4.2.3.1"), officialNumber: "4.2.0", pdfPage: 97, latex: "C_{\\varphi}=\\frac{\\varphi_r}{\\varphi_y}\\ge1" },
