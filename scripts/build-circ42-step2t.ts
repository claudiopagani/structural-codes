...
function makeUnit(number: string, title: string, parent: string, ancestors: string[], position: number, blocks: GeneratedBlock[], formulaIds: string[], tableIds: string[], figureIds: string[]) {
...
const unit21212Record = makeUnit(unit21212, "Valori limite dei rapporti larghezza - spessore", uid("C4.2.12.1"), [uid("C4.2"), uid("C4.2.12"), uid("C4.2.12.1")], 2, blocks21212, [formulaId(formula102.number)], [tableXIXId], []);
const unit21213Record = makeUnit(unit21213, "Inflessione trasversale delle ali", uid("C4.2.12.1"), [uid("C4.2"), uid("C4.2.12"), uid("C4.2.12.1")], 3, blocks21213, [formulaId(formula103.number)], [], [figure25]);
const manifest = { $schema: "urn:structural-codes:schema:asset-manifest:v2", schemaVersion: "2.0.0-alpha.2", recordType: "asset-manifest", document: "circ2019", section: "C4.2-step2t", sourceId, status: "draft", formulas: [{ id: formulaId(formula102.number), unitId: uid(unit21212), officialNumber: formula102.number, pdfPage: formula102.page, latex: formula102.latex }, { id: formulaId(formula103.number), unitId: uid(unit21213), officialNumber: formula103.number, pdfPage: formula103.page, latex: formula103.latex }], tables: [tableXIX], figures: [{ id: figure25, unitId: uid(unit21213), officialNumber: "C4.2.25", pdfPage: 136, caption: "Figura C4.2.25 – Incurvamento delle piattabande", alt: "Incurvamento delle piattabande", imagePath: "figures/circ2019/figc4.2.25.png", region: figure25Region, sha256: "9ddff3f330cf91dfb9be1486b406f770050d01cf85ce325f60c0b4a137f82dd8" }] };
