...
const formula101: FormulaRow = { number: "C4.2.101", page: 135, latex: "f_{myk}=f_{yk}+\\frac{(f_{tk}-f_{yk})\\cdot k\\cdot n\\cdot t^2}{A_g}\\le0{,}5\\cdot(f_{tk}+f_{yk})", raw: "f_myk = f_yk + ((f_tk − f_yk)·k·n·t²)/A_g ≤ 0,5·(f_tk + f_yk) [C4.2.101]", region: reg(145, 85, 330, 45) };
