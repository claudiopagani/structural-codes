...
const units = [
    makeUnit("7.3.4", "ANALISI NON LINEARE DINAMICA O STATICA", [
        ...
        block("7.3.4", "li1", "list-item", [[224, 7, 7]], "- valutare gli spostamenti relativi allo SL di interesse;", { manual: true }),
        block("7.3.4", "li2", "list-item", [[224, 8, 8]], "- eseguire le verifiche di duttilità relative allo SLC;", { manual: true }),
    ...
    makeUnit("7.3.6", "RISPETTO DEI REQUISITI NEI CONFRONTI DEGLI STATI LIMITE", [
        ...
        block("7.3.6", "p5", "paragraph", [[225, 48, 49]], "Le verifiche allo stato limite di prevenzione del collasso (SLC), a meno di specifiche indicazioni, si svolgono soltanto in termini di duttilità e solo qualora le verifiche in duttilità siano espressamente richieste (v. § 7.3.6.1)", { manual: true }),
    ], [], ["7.3.iii"]),
    makeUnit("7.3.6.1", "ELEMENTI STRUTTURALI (ST)", [
        ...
        block("7.3.6.1", "li-h", "list-item", [[227, 5, 5]], "- a 1,2 volte la domanda in duttilità locale, valutata in corrispondenza dello SLV, nel caso si utilizzino modelli lineari,", { manual: true }),
        block("7.3.6.1", "li-i", "list-item", [[227, 6, 6]], "- alla domanda in duttilità locale e globale allo SLC, nel caso si utilizzino modelli non lineari.", { manual: true }),
        block("7.3.6.1", "p18", "paragraph", [[227, 7, 7]], "Le verifiche di duttilità non sono dovute nel caso di progettazione con q ≤ 1,5.", { manual: true, inline: inlineTerms("Le verifiche di duttilità non sono dovute nel caso di progettazione con q ≤ 1,5.", [["q ≤ 1,5", "q\\le1{,}5"]]) }),
...
const formulaRows = [
    ...
    [fDrFragile, "7.3.6.1", "7.3.11a", "q\\,d_r\\le0{,}0050\\cdot h"],
    [fDrDuctile, "7.3.6.1", "7.3.11b", "q\\,d_r\\le0{,}0075\\cdot h"],
    [fDrRelative, "7.3.6.1", "7.3.12", "q\\,d_r\\le d_{rp}\\le0{,}0100\\cdot h"],
    [fDrMasonry, "7.3.6.1", "7.3.13", "q\\,d_r\\le0{,}0020\\cdot h"],
    [fDrReinforced, "7.3.6.1", "7.3.14", "q\\,d_r\\le0{,}0030\\cdot h"],
    [fDrConfined, "7.3.6.1", "7.3.15", "q\\,d_r<0{,}0025\\cdot h"],
] as const;
