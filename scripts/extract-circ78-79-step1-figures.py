"""Extract the official raster crop for Circolare 7/2019 C7.9.1."""
...
MANIFEST = ROOT / "corpus" / "assets" / "circ2019" / "7.8-7.9.json"
...
def main() -> None:
    ...
    print(f"circ78-79-step1-figures: extracted {len(manifest['figures'])} figure")
