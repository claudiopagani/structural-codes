...
const blocksByUnit: Record<string, BlockDef[]> = {
    ...
    "4.4.8.1.6": [
        ...
        li(141, "km = 0,7 per sezioni trasversali rettangolari;", [m("km", "k_m"), t(" = 0,7 per sezioni trasversali rettangolari;")]),
        li(141, "km = 1,0 per altre sezioni trasversali.", [m("km", "k_m"), t(" = 1,0 per altre sezioni trasversali.")]),
    ...
    "4.4.8.1.10": [
        ...
        li(142, "ksh = 1,2 per sezioni circolari piene;", [m("ksh", "k_{\\mathrm{sh}}"), t(" = 1,2 per sezioni circolari piene;")]),
        li(142, "ksh = 1 + 0,15 h/b ≤ 2 per sezioni rettangolari piene, di lati b e h, b ≤ h;", [m("ksh", "k_{\\mathrm{sh}}"), t(" = 1 + 0,15 "), m("h/b", "h/b"), t(" ≤ 2 per sezioni rettangolari piene, di lati "), m("b", "b"), t(" e "), m("h", "h"), t(", "), m("b", "b"), t(" ≤ "), m("h", "h"), t(";")]),
        li(142, "ksh = 1 per altri tipi di sezione.", [m("ksh", "k_{\\mathrm{sh}}"), t(" = 1 per altri tipi di sezione.")]),
    ],
    "4.4.8.1.11": [
    ...
    "4.4.8.2.1": [
        ...
        f(142, "4.4.12"),
        p(142, "λrel,m = √(fm,k/σm,crit) è la snellezza relativa di trave;", [m("λrel,m", "\\lambda_{\\mathrm{rel},m}"), t(" = "), m("√(fm,k/σm,crit)", "\\sqrt{f_{m,k}/\\sigma_{m,\\mathrm{crit}}}"), t(" è la snellezza relativa di trave;")]),
    ...
    "4.4.8.2.2": [
        ...
        p(143, "Quando λrel,c ≤ 0,3 si deve porre kcrit,c = 1, altrimenti", [t("Quando "), m("λrel,c", "\\lambda_{\\mathrm{rel},c}"), t(" ≤ 0,3 si deve porre "), m("kcrit,c", "k_{\\mathrm{crit},c}"), t(" = 1, altrimenti")]),
        f(143, "4.4.15"),
        ...
        li(143, "per legno massiccio βc = 0,2;", [t("per legno massiccio "), m("βc", "\\beta_c"), t(" = 0,2;")]),
        li(143, "per legno lamellare βc = 0,1.", [t("per legno lamellare "), m("βc", "\\beta_c"), t(" = 0,1.")]),
    ],
    "4.4.9": [
