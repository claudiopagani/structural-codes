...
const units = [
    makeUnit("7.3.1", "ANALISI LINEARE O NON LINEARE", [
        ...
        autoBlock("7.3.1", "p11", "paragraph", [[221, 63, 66]], { inline: inlineTerms(autoNormalize(raw([[221, 63, 66]])), [["SLV", "\\mathrm{SLV}"], ["SLD", "\\mathrm{SLD}"]]) }),
        ...
        autoBlock("7.3.1", "p15", "paragraph", [[221, 84, 85]]),
        ...
        autoBlock("7.3.1", "p17", "paragraph", [[222, 7, 8]], { inline: inlineTerms(autoNormalize(raw([[222, 7, 8]])), [["q", "q"]]) }),
        autoBlock("7.3.1", "p18", "paragraph", [[222, 9, 9]]),
    ...
    makeUnit("7.3.3.1", "ANALISI LINEARE DINAMICA", [
        ...
        block("7.3.3.1", "p4", "paragraph", [[223, 3, 6]], "con: E_j valore dell’effetto relativo al modo j; ρ_{ij} coefficiente di correlazione tra il modo i e il modo j, calcolato con formule di comprovata validità quale:", { manual: true, inline: inlineTerms("con: E_j valore dell’effetto relativo al modo j; ρ_{ij} coefficiente di correlazione tra il modo i e il modo j, calcolato con formule di comprovata validità quale:", [["E_j", "E_j"], ["ρ_{ij}", "\\rho_{ij}"], ["j", "j"], ["i", "i"]]) }),
    ...
    makeUnit("7.3.3.2", "ANALISI LINEARE STATICA", [
        ...
        block("7.3.3.2", "p8", "paragraph", [[223, 68, 68]], "F_i è la forza da applicare alla massa i-esima;", { manual: true, inline: inlineTerms("F_i è la forza da applicare alla massa i-esima;", [["F_i", "F_i"], ["i", "i"]]) }),
        block("7.3.3.2", "p9", "paragraph", [[223, 69, 69]], "W_i e W_j sono i pesi, rispettivamente, della massa i e della massa j;", { manual: true, inline: inlineTerms("W_i e W_j sono i pesi, rispettivamente, della massa i e della massa j;", [["W_i", "W_i"], ["W_j", "W_j"], ["i", "i"], ["j", "j"]]) }),
        block("7.3.3.2", "p10", "paragraph", [[223, 70, 71]], "z_i e z_j sono le quote, rispetto al piano di fondazione (v. § 3.2.3.1), delle masse i e j;", { manual: true, inline: inlineTerms("z_i e z_j sono le quote, rispetto al piano di fondazione (v. § 3.2.3.1), delle masse i e j;", [["z_i", "z_i"], ["z_j", "z_j"], ["i", "i"], ["j", "j"]]) }),
    ...
    makeUnit("7.3.3.3", "VALUTAZIONE DEGLI SPOSTAMENTI DELLA STRUTTURA", [
        ...
        block("7.3.3.3", "p3", "paragraph", [[223, 97, 97]], "In ogni caso μ_d ≤ 5q − 4.", { manual: true, inline: inlineTerms("In ogni caso μ_d ≤ 5q − 4.", [["μ_d", "\\mu_d"], ["≤", "\\le"], ["q", "q"]]) }),
        block("7.3.3.3", "p4", "paragraph", [[224, 3, 4]], "Gli spostamenti allo SLC si possono ottenere, in assenza di più accurate valutazioni che considerino l’effettivo rapporto delle ordinate spettrali in spostamento, moltiplicando per 1,25 gli spostamenti allo SLV.", { manual: true, inline: inlineTerms("Gli spostamenti allo SLC si possono ottenere, in assenza di più accurate valutazioni che considerino l’effettivo rapporto delle ordinate spettrali in spostamento, moltiplicando per 1,25 gli spostamenti allo SLV.", [["SLC", "\\mathrm{SLC}"], ["SLV", "\\mathrm{SLV}"]]) }),
    ], [fDe, fMu]),
];

const formulaRows = [
    [fQlim, "7.3.1", "7.3.1", "q_{\\lim}=q_0\\cdot K_R"],
    [fKw, "7.3.1", null, "k_w=\\begin{cases}1{,}00 & \\text{per strutture a telaio e miste equivalenti a telai}\\\\0{,}5\\le(1+\\alpha_0)/3\\le1 & \\text{per strutture a pareti, miste equivalenti a pareti, torsionalmente deformabili}\\end{cases}"],
    [fQnd, "7.3.1", "7.3.2", "1\\le q_{ND}=\\frac{2}{3}q_{\\mathrm{CD\"B\"}}\\le1{,}5"],
    [fTheta, "7.3.1", "7.3.3", "\\theta=\\frac{P\\cdot d_{ER}}{V\\cdot h}"],
    [fE, "7.3.3.1", "7.3.4", "E=\\sqrt{\\sum_i\\sum_j\\rho_{ij}\\cdot E_i\\cdot E_j}"],
    ...
    [fRhoB, "7.3.3.1", "7.3.5b", "\\rho_{ij}=\\frac{8\\xi^2\\beta_{ij}^{3/2}}{(1+\\beta_{ij})\\left[(1-\\beta_{ij})^2+4\\xi^2\\beta_{ij}\\right]}"],
    ...
    [fMu, "7.3.3.3", "7.3.9", "\\mu_d=\\begin{cases}q & \\text{se }T_1\\ge T_C\\\\1+(q-1)\\frac{T_C}{T_1} & \\text{se }T_1<T_C\\end{cases}"],
] as const;
