...
const manifest = { $schema: "urn:structural-codes:schema:asset-manifest:v2", schemaVersion: "2.0.0-alpha.2", recordType: "asset-manifest", document: "circ2019", section: "C4.2-step2r", sourceId, status: "draft", formulas: [{ id: formulaId(formula100.number), unitId: uid(unitNumber), officialNumber: formula100.number, pdfPage: formula100.page, latex: formula100.latex }], tables: [], figures: [] };
