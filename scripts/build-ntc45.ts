...
const formulaAssets = [
    ...
    formula("4.5.4", "4.5.6.2", 148, "f_{d,\\mathrm{rid}}=\\Phi\\cdot f_d"),
    ...
    formula(
        ...
        "4.5.6.2",
        149,
        "e_{s1}=\\frac{N_1d_1}{N_1+\\sum N_2};\\quad e_{s2}=\\frac{\\sum N_2d_2}{N_1+\\sum N_2}",
    ),
    formula("4.5.8", "4.5.6.2", 149, "e_a=h/200"),
    formula("4.5.9", "4.5.6.2", 149, "e_v=M_v/N"),
    formula("4.5.10", "4.5.6.2", 150, "e_1=\\lvert e_s\\rvert+e_a;\\quad e_2=\\frac{e_1}{2}+\\lvert e_v\\rvert"),
...
const units = [
    ...
    makeUnit("4.5.2.2.1", "Elementi artificiali", "subparagraph", [
        ...
        p("4.5.2.2.1", "editorial-005", 146, 167, ["La percentuale di foratura è espressa dalla relazione ", m("φ = 100 F/A", "\\varphi=100F/A"), " dove:"]),
        ...
        p("4.5.2.2.1", "editorial-008", 146, 201, ["Nel caso dei blocchi in laterizio estrusi la percentuale di foratura ", m("φ", "\\varphi"), " coincide con la percentuale in volume dei vuoti come definita dalla norma UNI EN 772-9:2007."]),
