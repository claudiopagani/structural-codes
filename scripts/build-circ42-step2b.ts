...
const formulaRows: FormulaRow[] = [
    { number: "C4.2.30", unit: "C4.2.4.1.3.2", page: 109, latex: "M_{cr}=\\psi\\cdot\\frac{\\pi}{L_{cr}}\\cdot\\sqrt{EJ_y\\cdot GJ_T}\\cdot\\sqrt{1+\\left(\\frac{\\pi}{L_{cr}}\\right)^2\\cdot\\frac{EJ_\\omega}{GJ_T}}", raw: "Mcr = ψ · π/Lcr · √(EJy · GJT) · √(1 + (π/Lcr)² · EJω/GJT) [C4.2.30]", region: reg(120, 250, 360, 90) },
    { number: "C4.2.31", unit: "C4.2.4.1.3.2", page: 109, latex: "\\psi=1{,}75-1{,}05\\cdot\\frac{M_B}{M_A}+0{,}3\\cdot\\left(\\frac{M_B}{M_A}\\right)^2", raw: "ψ = 1,75 − 1,05 · MB/MA + 0,3 · (MB/MA)² [C4.2.31]", region: reg(140, 390, 330, 80) },
    { number: "C4.2.32", unit: "C4.2.4.1.3.3.1", page: 109, latex: "\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_{min}\\cdot f_{yk}\\cdot A}+\\frac{M_{y,eq,Ed}\\cdot\\gamma_{M1}}{f_{yk}\\cdot W_y\\cdot\\left(1-N_{Ed}/N_{cr,y}\\right)}+\\frac{M_{z,eq,Ed}\\cdot\\gamma_{M1}}{f_{yk}\\cdot W_z\\cdot\\left(1-N_{Ed}/N_{cr,z}\\right)}\\le1", raw: "NEd · γM1/(χmin · fyk · A) + Myeq,Ed · γM1/[fyk · Wy · (1 − NEd/Ncr,y)] + Mzeq,Ed · γM1/[fyk · Wz · (1 − NEd/Ncr,z)] ≤ 1 [C4.2.32]", region: reg(105, 610, 390, 110) },
    { number: "C4.2.33", unit: "C4.2.4.1.3.3.1", page: 109, latex: "M_{eq,Ed}=1{,}3\\cdot M_{m,Ed}", raw: "Meq,Ed = 1,3 · Mm,Ed [C4.2.33]", region: reg(150, 735, 320, 70) },
    { number: "C4.2.34", unit: "C4.2.4.1.3.3.1", page: 109, latex: "0{,}75\\cdot M_{max,Ed}\\le M_{eq,Ed}\\le M_{max,Ed}", raw: "0,75 · Mmax,Ed ≤ Meq,Ed ≤ Mmax,Ed [C4.2.34]", region: reg(145, 790, 330, 50) },
    { number: "C4.2.35", unit: "C4.2.4.1.3.3.1", page: 110, latex: "M_{eq,Ed}=0{,}6\\cdot M_a-0{,}4\\cdot M_b\\ge0{,}4\\cdot M_a", raw: "Meq,Ed = 0,6 · Ma − 0,4 · Mb ≥ 0,4 · Ma [C4.2.35]", region: reg(120, 55, 360, 65) },
    { number: "C4.2.36", unit: "C4.2.4.1.3.3.1", page: 110, latex: "\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_{min}\\cdot f_{yk}\\cdot A}+\\frac{M_{y,eq,Ed}\\cdot\\gamma_{M1}}{\\chi_{LT}\\cdot f_{yk}\\cdot W_y\\cdot\\left(1-N_{Ed}/N_{cr,y}\\right)}+\\frac{M_{z,eq,Ed}\\cdot\\gamma_{M1}}{f_{yk}\\cdot W_z\\cdot\\left(1-N_{Ed}/N_{cr,z}\\right)}\\le1", raw: "NEd · γM1/(χmin · fyk · A) + Myeq,Ed · γM1/[χLT · fyk · Wy · (1 − NEd/Ncr,y)] + Mzeq,Ed · γM1/[fyk · Wz · (1 − NEd/Ncr,z)] ≤ 1 [C4.2.36]", region: reg(100, 145, 400, 105) },
    { number: "C4.2.37", unit: "C4.2.4.1.3.3.2", page: 110, latex: "\\begin{aligned}\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_y\\cdot A\\cdot f_{yk}}+k_{yy}\\cdot\\frac{M_{y,Ed}\\cdot\\gamma_{M1}}{\\chi_{LT}\\cdot W_y\\cdot f_{yk}}+k_{yz}\\cdot\\frac{M_{z,Ed}\\cdot\\gamma_{M1}}{W_z\\cdot f_{yk}}&\\le1\\\\\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_z\\cdot A\\cdot f_{yk}}+k_{zy}\\cdot\\frac{M_{y,Ed}\\cdot\\gamma_{M1}}{\\chi_{LT}\\cdot W_y\\cdot f_{yk}}+k_{zz}\\cdot\\frac{M_{z,Ed}\\cdot\\gamma_{M1}}{W_z\\cdot f_{yk}}&\\le1\\end{aligned}", raw: "[C4.2.37] NEd · γM1/(χy · A · fyk) + kyy · My,Ed · γM1/(χLT · Wy · fyk) + kyz · Mz,Ed · γM1/(Wz · fyk) ≤ 1; NEd · γM1/(χz · A · fyk) + kzy · My,Ed · γM1/(χLT · Wy · fyk) + kzz · Mz,Ed · γM1/(Wz · fyk) ≤ 1", region: reg(100, 300, 400, 155) },
    { number: "C4.2.38", unit: "C4.2.4.1.3.3.2", page: 110, latex: "\\begin{aligned}\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_y\\cdot A_{eff}\\cdot f_{yk}}+k_{yy}\\cdot\\frac{(M_{y,Ed}+\\Delta M_{y,Ed})\\cdot\\gamma_{M1}}{\\chi_{LT}\\cdot W_{eff,y}\\cdot f_{yk}}+k_{yz}\\cdot\\frac{(M_{z,Ed}+\\Delta M_{z,Ed})\\cdot\\gamma_{M1}}{W_{eff,z}\\cdot f_{yk}}&\\le1\\\\\\frac{N_{Ed}\\cdot\\gamma_{M1}}{\\chi_z\\cdot A_{eff}\\cdot f_{yk}}+k_{zy}\\cdot\\frac{(M_{y,Ed}+\\Delta M_{y,Ed})\\cdot\\gamma_{M1}}{\\chi_{LT}\\cdot W_{eff,y}\\cdot f_{yk}}+k_{zz}\\cdot\\frac{(M_{z,Ed}+\\Delta M_{z,Ed})\\cdot\\gamma_{M1}}{W_{eff,z}\\cdot f_{yk}}&\\le1\\end{aligned}", raw: "[C4.2.38] NEd · γM1/(χy · Aeff · fyk) + kyy · (My,Ed + ΔMy,Ed) · γM1/(χLT · Weff,y · fyk) + kyz · (Mz,Ed + ΔMz,Ed) · γM1/(Weff,z · fyk) ≤ 1; NEd · γM1/(χz · Aeff · fyk) + kzy · (My,Ed + ΔMy,Ed) · γM1/(χLT · Weff,y · fyk) + kzz · (Mz,Ed + ΔMz,Ed) · γM1/(Weff,z · fyk) ≤ 1", region: reg(100, 450, 400, 160) },
    { number: "C4.2.39", unit: "C4.2.4.1.3.3.2", page: 110, latex: "\\Delta M_{y,Ed}=e_{N,z}\\cdot N_{Ed}\\qquad\\Delta M_{z,Ed}=e_{N,y}\\cdot N_{Ed}", raw: "ΔMy,Ed = eN,z · NEd e ΔMz,Ed = eN,y · NEd [C4.2.39]", region: reg(130, 635, 350, 80) },
    ...
    { number: "C4.2.42", unit: "C4.2.4.1.3.3.3", page: 112, latex: "\\frac{\\chi_{op}\\cdot\\alpha_{ult,k}}{\\gamma_{M1}}\\ge1{,}0", raw: "χop · αult,k/γM1 ≥ 1,0 [C4.2.42]", region: reg(125, 760, 350, 80) },
];
