...
makeUnit("C8.8.5.4", "VERIFICA DEI MECCANISMI DUTTILI", "C8.8.5", ["C8", "C8.8", "C8.8.5"], 4, [301, 28], (blocks) => {
  ...
  addProse(blocks, r(301, 45)); addFormulaRef(blocks, r(302, 3), "C8.8.5.4"); addText(blocks, r(302, 4), "con γₑₗ = 1.5. Nel caso di verifica allo SLV la capacità è pari a ¾ di quella per lo SLC.", "paragraph", mathSegments(["con ", ["γₑₗ = 1.5", "\\gamma_{el}=1.5"], ". Nel caso di verifica allo SLV la capacità è pari a ", ["¾", "3/4"], " di quella per lo SLC."]));
