...
const formulaRows: FormulaRow[] = [
    { number: "C4.2.77", unit: unitNumber, page: 121, latex: "\\sigma_{\\mathrm{cr,p}}=k_{\\sigma,\\mathrm{p}}\\,\\frac{\\pi^2 E}{12(1-\\nu^2)}\\left(\\frac{t}{b}\\right)^2", raw: "σ_cr,p = k_σ,p · π² E/[12(1 − ν²)] · (t/b)² [C4.2.77]", region: reg(145, 65, 310, 55) },
    ...
    { number: "C4.2.79", unit: unitNumber, page: 121, latex: "\\gamma=\\frac{12(1-\\nu^2)I_{\\mathrm{sl}}}{b\\,t^3}", raw: "γ = 12(1 − ν²) I_sl/(b · t³) [C4.2.79]", region: reg(170, 365, 260, 50) },
    { number: "C4.2.80", unit: unitNumber, page: 121, latex: "\\delta=\\frac{\\sum A_{\\mathrm{sl}}}{b\\,t}", raw: "δ = ΣA_sl/(b · t) [C4.2.80]", region: reg(175, 425, 245, 50) },
    { number: "C4.2.81.a", unit: unitNumber, page: 121, latex: "\\sigma_{\\mathrm{cr,sl}}=\\frac{1{,}05\\,E}{A_{\\mathrm{sl,1}}}\\sqrt{\\frac{I_{\\mathrm{sl,1}}\\,t^3\\,b}{b_1b_2}}\\quad\\text{se }a\\ge a_c", raw: "σ_cr,sl = (1,05 · E/A_sl,1) · √(I_sl,1 · t³ · b/(b₁ · b₂)) se a ≥ a_c [C4.2.81.a]", region: reg(125, 505, 345, 70) },
    { number: "C4.2.81.b", unit: unitNumber, page: 121, latex: "\\sigma_{\\mathrm{cr,sl}}=\\frac{\\pi^2 E I_{\\mathrm{sl,1}}}{A_{\\mathrm{sl,1}}a^2}+\\frac{E b a^2 t^3}{4\\pi^2(1-\\nu^2)A_{\\mathrm{sl,1}}b_1^2b_2^2}\\quad\\text{se }a<a_c", raw: "σ_cr,sl = π² E I_sl,1/(A_sl,1 · a²) + E b · a² · t³/[4π²(1 − ν²) A_sl,1 · b₁² · b₂²] se a < a_c [C4.2.81.b]", region: reg(105, 580, 405, 70) },
    { number: "C4.2.82", unit: unitNumber, page: 121, latex: "a_c=4{,}33\\sqrt[4]{\\frac{I_{\\mathrm{sl,1}}b_1^2b_2^2}{t^3b}}", raw: "a_c = 4,33 · ⁴√(I_sl,1 · b₁² · b₂²/(t³ · b)) [C4.2.82]", region: reg(185, 700, 250, 60) },
