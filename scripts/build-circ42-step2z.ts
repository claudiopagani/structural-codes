...
const formula133: FormulaRow = { number: "C4.2.133", page: 143, latex: "F_{b,Rd}=\\frac{\\alpha\\,f_{tk}\\,d\\,t}{\\gamma_{M2}}", raw: "F_b,Rd = α·f_tk·d·t/γ_M2 [C4.2.133]", region: reg(145, 285, 325, 45) };
const formula134: FormulaRow = { number: "C4.2.134", page: 143, latex: "\\begin{aligned}\\alpha&=3{,}6\\,\\sqrt{\\frac{t}{d}}\\le2{,}1&&\\text{per }t_1=t\\text{ oppure per }t_1\\ge2{,}5\\,t\\text{ e }t<1\\,\\mathrm{mm}\\\\\\alpha&=2{,}1&&\\text{per }t_1\\ge2{,}5\\,t\\text{ e }t\\ge1\\,\\mathrm{mm}\\end{aligned}", raw: "α = 3,6·√(t/d) ≤ 2,1 per t_1 = t oppure per t_1 ≥ 2,5·t e t < 1 mm; α = 2,1 per t_1 ≥ 2,5·t e t ≥ 1 mm [C4.2.134]", region: reg(145, 330, 325, 70) };
const formula135: FormulaRow = { number: "C4.2.135", page: 143, latex: "F_{t,Rd}=\\frac{f_{tk}\\,e_1\\,t}{1{,}2\\,\\gamma_{M2}}", raw: "F_t,Rd = f_tk·e_1·t/(1,2·γ_M2) [C4.2.135]", region: reg(145, 410, 325, 45) };
const formula136: FormulaRow = { number: "C4.2.136", page: 143, latex: "F_{n,Rd}=\\frac{A_{net}\\,f_{tk}}{\\gamma_{M2}}", raw: "F_n,Rd = A_net·f_tk/γ_M2 [C4.2.136]", region: reg(145, 455, 325, 45) };
const formula137: FormulaRow = { number: "C4.2.137", page: 143, latex: "F_{p,Rd}=\\frac{f_{tk}\\,d_w\\,t}{\\gamma_{M2}}", raw: "F_p,Rd = f_tk·d_w·t/γ_M2 [C4.2.137]", region: reg(145, 510, 325, 45) };
const formula138: FormulaRow = { number: "C4.2.138", page: 143, latex: "\\begin{aligned}F_{0,Rd}&=\\frac{0{,}45\\,t\\,d\\,f_{tk}}{\\gamma_{M2}}&&\\text{per }t_1<s\\\\F_{0,Rd}&=\\frac{0{,}65\\,t\\,d\\,f_{tk}}{\\gamma_{M2}}&&\\text{per }t_1\\ge s\\end{aligned}", raw: "F_0,Rd = 0,45·t·d·f_tk/γ_M2 per t_1 < s; F_0,Rd = 0,65·t·d·f_tk/γ_M2 per t_1 ≥ s [C4.2.138]", region: reg(145, 560, 325, 70) };
...
const formula140: FormulaRow = { number: "C4.2.140", page: 143, latex: "e_1\\ge3{,}0\\,d\\ ;\\quad p_1\\ge3\\,d\\ ;\\quad e_2\\ge1{,}5\\,d\\ ;\\quad p_2\\ge3\\,d", raw: "e_1 ≥ 3,0·d; p_1 ≥ 3·d; e_2 ≥ 1,5·d; p_2 ≥ 3·d [C4.2.140]", region: reg(145, 685, 325, 45) };
