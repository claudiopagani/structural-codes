...
const tables = [
    ...
    },
    {
        ...
        headers: [[cell("Categoria", { align: "center" }), cell("Caratteristiche della superficie topografica")]],
        rows: [
            [cell("T1", { align: "center" }), inlineCell("Superficie pianeggiante, pendii e rilievi isolati con inclinazione media i ≤ 15°", [text("Superficie pianeggiante, pendii e rilievi isolati con inclinazione media "), math("i ≤ 15°", "i\\le15^\\circ")])],
            [cell("T2", { align: "center" }), inlineCell("Pendii con inclinazione media i > 15°", [text("Pendii con inclinazione media "), math("i > 15°", "i>15^\\circ")])],
            [cell("T3", { align: "center" }), inlineCell("Rilievi con larghezza in cresta molto minore che alla base e inclinazione media 15° ≤ i ≤ 30°", [text("Rilievi con larghezza in cresta molto minore che alla base e inclinazione media "), math("15° ≤ i ≤ 30°", "15^\\circ\\le i\\le30^\\circ")])],
            [cell("T4", { align: "center" }), inlineCell("Rilievi con larghezza in cresta molto minore che alla base e inclinazione media i > 30°", [text("Rilievi con larghezza in cresta molto minore che alla base e inclinazione media "), math("i > 30°", "i>30^\\circ")])],
        ],
        notes: [],
    },
    {
        ...
        rows: [
            ...
            [cell("B", { strong: true }), mathCell("1,00 ≤ 1,40 − 0,40 · Fo · ag/g ≤ 1,20", "1{,}00\\le1{,}40-0{,}40\\cdot F_o\\cdot\\dfrac{a_g}{g}\\le1{,}20"), mathCell("1,10 · (TC*)^-0,20", "1{,}10\\cdot(T_C^*)^{-0{,}20}")],
            [cell("C", { strong: true }), mathCell("1,00 ≤ 1,70 − 0,60 · Fo · ag/g ≤ 1,50", "1{,}00\\le1{,}70-0{,}60\\cdot F_o\\cdot\\dfrac{a_g}{g}\\le1{,}50"), mathCell("1,05 · (TC*)^-0,33", "1{,}05\\cdot(T_C^*)^{-0{,}33}")],
            [cell("D", { strong: true }), mathCell("0,90 ≤ 2,40 − 1,50 · Fo · ag/g ≤ 1,80", "0{,}90\\le2{,}40-1{,}50\\cdot F_o\\cdot\\dfrac{a_g}{g}\\le1{,}80"), mathCell("1,25 · (TC*)^-0,50", "1{,}25\\cdot(T_C^*)^{-0{,}50}")],
            [cell("E", { strong: true }), mathCell("1,00 ≤ 2,00 − 1,10 · Fo · ag/g ≤ 1,60", "1{,}00\\le2{,}00-1{,}10\\cdot F_o\\cdot\\dfrac{a_g}{g}\\le1{,}60"), mathCell("1,15 · (TC*)^-0,40", "1{,}15\\cdot(T_C^*)^{-0{,}40}")],
        ],
        notes: [],
    },
    {
