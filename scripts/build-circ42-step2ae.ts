...
const formula159: FormulaRow = { number: "C4.2.159", page: 145, latex: "e_1\\ge\\frac{2{,}1\\,F_{w,Sd}\\,\\gamma_{M2}}{f_{tk}\\,t}", raw: "e_1 ≥ 2,1·F_w,Sd·γ_M2/(f_tk·t) [C4.2.159]", region: reg(145, 690, 325, 45) };
const formula160: FormulaRow = { number: "C4.2.160", page: 146, latex: "F_{w,Sd}=\\frac{0{,}25\\,\\pi\\,d_s^2\\,0{,}625\\,f_{tk}}{\\gamma_{M2}}", raw: "F_w,Sd = 0,25·π·d_s²·0,625·f_tk/γ_M2 [C4.2.160]", region: reg(145, 75, 325, 45) };
const formula161: FormulaRow = { number: "C4.2.161", page: 146, latex: "d_s=0{,}7\\,d_w-1{,}5\\,\\sum t", raw: "d_s = 0,7·d_w − 1,5·Σt [C4.2.161]", region: reg(145, 125, 325, 45) };
const formula162: FormulaRow = { number: "C4.2.162", page: 146, latex: "\\begin{aligned}F_{w,Sd}&\\le\\frac{1{,}5\\,d_p\\,f_{tk}\\,\\sum t}{\\gamma_{M2}}&&\\text{per }\\frac{d_p}{\\sum t}\\le18\\,\\sqrt{\\frac{420}{f_{tk}}}\\\\F_{w,Sd}&\\le\\frac{27\\,f_{tk}\\,(\\sum t)^2}{\\gamma_{M2}}\\sqrt{\\frac{420}{f_{tk}}}&&\\text{per }18\\,\\sqrt{\\frac{420}{f_{tk}}}\\le\\frac{d_p}{\\sum t}\\le30\\,\\sqrt{\\frac{420}{f_{tk}}}\\\\F_{w,Sd}&\\le\\frac{0{,}9\\,d_p\\,f_{tk}\\,\\sum t}{\\gamma_{M2}}&&\\text{per }\\frac{d_p}{\\sum t}>30\\,\\sqrt{\\frac{420}{f_{tk}}}\\end{aligned}", raw: "F_w,Sd ≤ 1,5·d_p·f_tk·Σt/γ_M2 per d_p/Σt ≤ 18√(420/f_tk); F_w,Sd ≤ 27·f_tk·(Σt)²/γ_M2·√(420/f_tk) per 18√(420/f_tk) ≤ d_p/Σt ≤ 30√(420/f_tk); F_w,Sd ≤ 0,9·d_p·f_tk·Σt/γ_M2 per d_p/Σt > 30√(420/f_tk) [C4.2.162]", region: reg(145, 175, 325, 105) };
const formula163: FormulaRow = { number: "C4.2.163", page: 146, latex: "F_{w,Sd}=\\frac{\\left(0{,}25\\,\\pi\\,d_s^2+L_w\\,d_s\\right)\\,0{,}625\\,f_{tk}}{\\gamma_{M2}}", raw: "F_w,Sd = (0,25·π·d_s² + L_w·d_s)·0,625·f_tk/γ_M2 [C4.2.163]", region: reg(145, 305, 325, 50) };
const formula164: FormulaRow = { number: "C4.2.164", page: 146, latex: "F_{w,Sd}\\le\\frac{\\left(0{,}5\\,L_w+1{,}67\\,d_p\\right)\\,f_{tk}\\,\\sum t}{\\gamma_{M2}}", raw: "F_w,Sd ≤ (0,5·L_w + 1,67·d_p)·f_tk·Σt/γ_M2 [C4.2.164]", region: reg(145, 360, 325, 50) };
const formula165: FormulaRow = { number: "C4.2.165", page: 146, latex: "d_p=d_w-t", raw: "d_p = d_w − t [C4.2.165]", region: reg(145, 430, 325, 45) };
const formula166: FormulaRow = { number: "C4.2.166", page: 146, latex: "d_p=d_w-2\\,\\sum t", raw: "d_p = d_w − 2·Σt [C4.2.166]", region: reg(145, 475, 325, 45) };
