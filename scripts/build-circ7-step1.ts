...
const c7: Block[] = [
    ...
    li(198, "la scomparsa di qualunque riferimento alla zonazione sismica, sostituita dalla indicazione dei livelli di accelerazione agS, attesa allo SLV;"),
...
const c723: Block[] = [
    ...
    li(204, "S_eZ,k è il contributo allo spettro di risposta di piano fornito dal k-esimo modo della struttura principale, di periodo proprio T_k e smorzamento viscoso equivalente ξ_k (in percentuale);"),
    ...
    li(204, "a_Z,k è il contributo del k-esimo modo alla accelerazione massima di piano."),
    ...
    formula(205, "C7.2.11"),
    h(205, "dove:"),
    li(205, "α è il rapporto tra l’accelerazione massima del terreno agS su sottosuolo tipo A da considerare nello stato limite in esame (si veda § 3.2.3.2.1) e l’accelerazione di gravità g;"),
...
const formulas = [
    ...
    ["C7.2.5", "C7.2.3", 203, "S_{eZ}(T,\\xi,z)=\\sqrt{\\sum_k\\left(S_{eZ,k}(T,\\xi,z)\\right)^2}\\;\\left(\\ge S_e(T,\\xi)\\text{ per }T>T_1\\right)"],
