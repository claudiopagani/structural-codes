...
const manifest = { $schema: "urn:structural-codes:schema:asset-manifest:v2", schemaVersion: "2.0.0-alpha.2", recordType: "asset-manifest", document: "circ2019", section: "C4.2-step2ad", sourceId, status: "draft", formulas: formulaRows.map((formula) => ({ id: formulaId(formula.number), unitId: uid(unit761), officialNumber: formula.number, pdfPage: formula.page, latex: formula.latex })), tables: [], figures: [] };
