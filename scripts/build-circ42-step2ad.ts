...
const formula154: FormulaRow = { number: "C4.2.154", page: 145, latex: "\\begin{aligned}F_{b,Rd}&=\\frac{2{,}7\\,f_{tk}\\,d_s\\,\\sqrt{t}}{\\gamma_{M2}}&&\\text{per }t\\le t_1\\le2{,}5\\,t\\\\F_{b,Rd}&=\\min\\left(\\frac{2{,}7\\,f_{tk}\\,d_s\\,\\sqrt{t}}{\\gamma_{M2}};\\frac{0{,}7\\,f_{tk}\\,d_s^2}{\\gamma_{M2}};\\frac{3{,}1\\,f_{tk}\\,d_s\\,t}{\\gamma_{M2}}\\right)&&\\text{per }t_1>2{,}5\\,t\\end{aligned}", raw: "F_b,Rd = 2,7·f_tk·d_s·√t/γ_M2 per t ≤ t_1 ≤ 2,5·t; F_b,Rd = min(2,7·f_tk·d_s·√t/γ_M2; 0,7·f_tk·d_s²/γ_M2; 3,1·f_tk·d_s·t/γ_M2) per t_1 > 2,5·t [C4.2.154]", region: reg(145, 250, 325, 80) };
const formula155: FormulaRow = { number: "C4.2.155", page: 145, latex: "F_{t,Rd}=\\frac{1{,}4\\,f_{tk}\\,e_1\\,t}{\\gamma_{M2}}", raw: "F_t,Rd = 1,4·f_tk·e_1·t/γ_M2 [C4.2.155]", region: reg(145, 330, 325, 45) };
const formula156: FormulaRow = { number: "C4.2.156", page: 145, latex: "F_{n,Rd}=\\frac{A_{net}\\,f_{tk}}{\\gamma_{M2}}", raw: "F_n,Rd = A_net·f_tk/γ_M2 [C4.2.156]", region: reg(145, 380, 325, 45) };
const formula157: FormulaRow = { number: "C4.2.157", page: 145, latex: "F_{v,Rd}=\\frac{0{,}25\\,\\pi\\,d_s^2\\,f_{tk}}{\\gamma_{M2}}", raw: "F_v,Rd = 0,25·π·d_s²·f_tk/γ_M2 [C4.2.157]", region: reg(145, 425, 325, 45) };
const formula158: FormulaRow = { number: "C4.2.158", page: 145, latex: "2\\,d_s\\le e_1\\le6\\,d_s\\ ;\\quad3\\,d_s\\le p_1\\le8\\,d_s\\ ;\\quad1{,}5\\,d_s\\le e_2\\le4\\,d_s\\ ;\\quad3\\,d_s\\le p_2\\le6\\,d_s", raw: "2·d_s ≤ e_1 ≤ 6·d_s; 3·d_s ≤ p_1 ≤ 8·d_s; 1,5·d_s ≤ e_2 ≤ 4·d_s; 3·d_s ≤ p_2 ≤ 6·d_s [C4.2.158]", region: reg(145, 475, 325, 45) };
...
const blocks761: GeneratedBlock[] = [
  ...
  block(unit761, "p7", "paragraph", 145, "dove d_s=0,5·t+5 mm per punti di fusione e d_s=5·t^0,5, t in mm, per punti a resistenza.", [text("dove "), math("d_s=0,5·t+5 mm", "d_s=0{,}5\\,t+5\\,\\mathrm{mm}"), text(" per punti di fusione e "), math("d_s=5·t^0,5", "d_s=5\\,t^{0{,}5}"), text(", "), math("t", "t"), text(" in mm, per punti a resistenza.")], reg(73.9, 560, 450, 30)),
];
