...
const p131 = {
    p3532b: region(82, 95, 430, 65), p3532c: region(82, 176, 430, 20), h354: region(82, 199, 430, 20), h3541: region(82, 220, 430, 20), p3541a: region(82, 234, 430, 18), f329: region(130, 240, 300, 35), p3541b: region(82, 260, 430, 30), f330: region(130, 275, 300, 35), phi: region(82, 312, 430, 25), table3541: region(82, 334, 360, 285), h3542: region(82, 627, 430, 20), p3542a: region(82, 640, 430, 20), f331: region(75, 650, 310, 25), f332: region(75, 675, 310, 25),
};
const p132 = {
...
const formulaAssets = [
    ...
    { id: formulaId("4.3.19"), unitId: unitId("4.3.5.2"), officialNumber: "4.3.19", pdfPage: 128, latex: "N_{pl,Rk}=A_a\\cdot f_{yk}+0{,}85\\cdot A_c\\cdot f_{ck}+A_s\\cdot f_{sk}" },
    { id: formulaId("4.3.20"), unitId: unitId("4.3.5.2"), officialNumber: "4.3.20", pdfPage: 128, latex: "(EJ)_{\\mathrm{eff,II}}=k_0\\cdot\\left(E_aJ_a+E_sJ_s+k_{e,II}E_{cm}\\cdot J_c\\right)" },
    { id: formulaId("4.3.21"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.21", pdfPage: 129, latex: "N_{pl,Rd}=\\frac{A_a\\cdot f_{yk}}{\\gamma_A}+\\frac{A_c\\cdot0{,}85\\cdot f_{ck}}{\\gamma_C}+\\frac{A_s\\cdot f_{sk}}{\\gamma_S}" },
    { id: formulaId("4.3.22"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.22", pdfPage: 129, latex: "N_{pl,Rd}=\\eta_a\\cdot\\frac{A_a\\cdot f_{yk}}{\\gamma_A}+\\frac{A_c\\cdot f_{ck}}{\\gamma_C}\\left(1+\\eta_c\\cdot\\frac{t}{d}\\cdot\\frac{f_{yk}}{f_{ck}}\\right)+\\frac{A_s\\cdot f_{sk}}{\\gamma_S}" },
    { id: formulaId("4.3.23"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.23", pdfPage: 129, latex: "\\eta_a=\\begin{cases}0{,}25\\left(3+2\\cdot\\bar{\\lambda}\\right)\\le1{,}0&e=0\\\\0{,}25\\left(3+2\\cdot\\bar{\\lambda}\\right)+10\\cdot\\left(0{,}25-0{,}5\\cdot\\bar{\\lambda}\\right)\\cdot\\frac{e}{d}&0<e/d\\le0{,}1\\\\1{,}0&e>0{,}1\\end{cases}" },
    { id: formulaId("4.3.24"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.24", pdfPage: 129, latex: "\\eta_c=\\begin{cases}\\left(4{,}9-18{,}5\\bar{\\lambda}+17\\cdot\\bar{\\lambda}^2\\right)\\ge0&e=0\\\\\\left(4{,}9-18{,}5\\bar{\\lambda}+17\\cdot\\bar{\\lambda}^2\\right)\\cdot\\left(1-10\\frac{e}{d}\\right)&0<e/d\\le0{,}1\\\\0&e>0{,}1\\end{cases}" },
    { id: formulaId("4.3.25"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.25", pdfPage: 130, latex: "N_{pm,Rd}=0{,}85\\cdot\\frac{f_{ck}}{\\gamma_C}\\cdot A_c" },
    { id: formulaId("4.3.26"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.26", pdfPage: 130, latex: "M_{pl,Rd}(N_{Ed})=\\mu_d\\cdot M_{pl,Rd}" },
    { id: formulaId("4.3.27"), unitId: unitId("4.3.5.3.1"), officialNumber: "4.3.27", pdfPage: 130, latex: "\\begin{aligned}\\frac{M_{y,Ed}}{\\mu_{dy}\\cdot M_{pl,y,Rd}}&\\le\\alpha_{M,y}&&\\frac{M_{z,Ed}}{\\mu_{dz}\\cdot M_{pl,z,Rd}}\\le\\alpha_{M,z}\\\\\\frac{M_{y,Ed}}{\\mu_{dy}\\cdot M_{pl,y,Rd}}+\\frac{M_{z,Ed}}{\\mu_{dz}\\cdot M_{pl,z,Rd}}&\\le1{,}0\\end{aligned}" },
    { id: formulaId("4.3.28"), unitId: unitId("4.3.5.3.2"), officialNumber: "4.3.28", pdfPage: 130, latex: "\\begin{aligned}V_{a,Ed}&=V_{Ed}\\cdot\\frac{M_{pl,a,Rd}}{M_{pl,Rd}}\\\\V_{c,Ed}&=V_{Ed}-V_{a,Ed}\\end{aligned}" },
    { id: formulaId("4.3.29"), unitId: unitId("4.3.5.4.1"), officialNumber: "4.3.29", pdfPage: 131, latex: "N_{b,Rd}=\\chi\\cdot N_{pl,Rd}" },
    ...
    { id: formulaId("4.3.31"), unitId: unitId("4.3.5.4.2"), officialNumber: "4.3.31", pdfPage: 131, latex: "\\frac{d}{t}\\le90\\cdot\\frac{235}{f_y}\\qquad\\text{per colonne circolari cave riempite;}" },
    { id: formulaId("4.3.32"), unitId: unitId("4.3.5.4.2"), officialNumber: "4.3.32", pdfPage: 131, latex: "\\frac{d}{t}\\le52\\cdot\\sqrt{\\frac{235}{f_y}}\\qquad\\text{per colonne rettangolari cave riempite;}" },
    { id: formulaId("4.3.33"), unitId: unitId("4.3.5.4.2"), officialNumber: "4.3.33", pdfPage: 132, latex: "\\frac{b}{t_f}\\le44\\cdot\\sqrt{\\frac{235}{f_y}}\\qquad\\text{per sezioni parzialmente rivestite;}" },
    { id: formulaId("4.3.34"), unitId: unitId("4.3.5.4.2"), officialNumber: "4.3.34", pdfPage: 132, latex: "c\\ge\\max\\left\\{40\\,\\mathrm{mm};\\frac{b}{6}\\right\\}\\qquad\\text{per sezioni completamente rivestite;}" },
];
...
const units = [
    ...
    makeUnit("4.3.5.1", "GENERALITÀ E TIPOLOGIE", "subparagraph", [
        ...
        textBlock("4.3.5.1", "list-009", "list-item", 128, p128.req5, "5. per le sezioni interamente rivestite, fig. 4.3.6, i copriferri massimi che si possono considerare nel calcolo sono c_y=0,4·b e c_z=0,3·h;", [t("5. per le sezioni interamente rivestite, fig. 4.3.6, i copriferri massimi che si possono considerare nel calcolo sono "), m("c_y=0,4·b", "c_y=0{,}4\\cdot b"), t(" e "), m("c_z=0,3·h", "c_z=0{,}3\\cdot h"), t(";")]),
        textBlock("4.3.5.1", "list-010", "list-item", 128, p128.req6, "6. il rapporto tra l’altezza h_c e la larghezza b_c della sezione deve essere 0,2 ≤ h_c/b_c ≤ 5,0;", [t("6. il rapporto tra l’altezza "), m("h_c", "h_c"), t(" e la larghezza "), m("b_c", "b_c"), t(" della sezione deve essere "), m("0,2 ≤ h_c/b_c ≤ 5,0", "0{,}2\\le h_c/b_c\\le5{,}0"), t(";")]),
    ...
    makeUnit("4.3.5.2", "RIGIDEZZA FLESSIONALE, SNELLEZZA E CONTRIBUTO MECCANICO DELL’ACCIAIO", "subparagraph", [
        ...
        textBlock("4.3.5.2", "definition-001", "paragraph", 128, p128.definitionEcm, "E_cm è il modulo elastico istantaneo del calcestruzzo", [m("E_cm", "E_{cm}"), t(" è il modulo elastico istantaneo del calcestruzzo")]),
        textBlock("4.3.5.2", "definition-002", "paragraph", 128, p128.definitionPhi, "φ è il coefficiente di viscosità definito al punto (11.2.10.7)", [m("φ", "\\varphi"), t(" è il coefficiente di viscosità definito al punto (11.2.10.7)")]),
        textBlock("4.3.5.2", "definition-003", "paragraph", 128, p128.definitionNEd, "N_Ed è la massima azione assiale di progetto", [m("N_Ed", "N_{Ed}"), t(" è la massima azione assiale di progetto")]),
        textBlock("4.3.5.2", "definition-004", "paragraph", 128, p128.definitionNGEd, "N_G,Ed è l’aliquota di azione assiale dovuta alle azioni permanenti", [m("N_G,Ed", "N_{G,Ed}"), t(" è l’aliquota di azione assiale dovuta alle azioni permanenti")]),
    ...
    makeUnit("4.3.5.3.1", "Resistenza della sezione per tensioni normali", "subparagraph", [
        ...
        textBlock("4.3.5.3.1", "p-004", "paragraph", 129, p129.p3531d, "La resistenza plastica di progetto della colonna circolare riempita di calcestruzzo, tenendo conto del confinamento, assume la seguente forma:", [], { wrap: true, hyphen: true, manual: true }),
        formulaRef("4.3.5.3.1", "4.3.22", "formula-002", 129, p129.f322),
        textBlock("4.3.5.3.1", "editorial-001", "paragraph", 129, p129.confinementDefinitions, "dove t è lo spessore del tubo di acciaio e d è il diametro esterno della colonna. Tale formula è valida nel caso in cui λ̄ ≤ 0,5 e l’eccentricità massima del carico, e = M_Ed/N_Ed, sia minore di 0,1. I coefficienti η_a ed η_c sono dati dalle seguenti espressioni", [t("dove "), m("t", "t"), t(" è lo spessore del tubo di acciaio e "), m("d", "d"), t(" è il diametro esterno della colonna. Tale formula è valida nel caso in cui "), m("λ̄ ≤ 0,5", "\\bar{\\lambda}\\le0{,}5"), t(" e l’eccentricità massima del carico, "), m("e = M_Ed/N_Ed", "e=M_{Ed}/N_{Ed}"), t(", sia minore di 0,1. I coefficienti "), m("η_a", "\\eta_a"), t(" ed "), m("η_c", "\\eta_c"), t(" sono dati dalle seguenti espressioni")], { wrap: true, manual: true }),
        formulaRef("4.3.5.3.1", "4.3.23", "formula-003", 129, p129.f323),
        formulaRef("4.3.5.3.1", "4.3.24", "formula-004", 129, p129.f324),
    ...
    makeUnit("4.3.5.4.1", "Colonne compresse", "subparagraph", [
        ...
        textBlock("4.3.5.4.1", "p-003", "paragraph", 131, p131.phi, "dove Φ = 0.5 [1 + α (λ̄ − 0.2) + λ̄²] e α è il fattore di imperfezione, ricavato dalla Tab. 4.3.III.", [t("dove "), m("Φ = 0.5 [1 + α (λ̄ − 0.2) + λ̄²]", "\\Phi=0.5\\left[1+\\alpha\\left(\\bar{\\lambda}-0.2\\right)+\\bar{\\lambda}^2\\right]"), t(" e "), m("α", "\\alpha"), t(" è il fattore di imperfezione, ricavato dalla Tab. 4.3.III.")]),
        assetRef("4.3.5.4.1", "table-001", "table-ref", tableId("4.3.iii"), 131, p131.table3541),
    ], { formulaIds: [formulaId("4.3.29"), formulaId("4.3.30")], tableIds: [tableId("4.3.iii")], figureIds: [] }),
    makeUnit("4.3.5.4.2", "Instabilità locale", "subparagraph", [
        ...
        formulaRef("4.3.5.4.2", "4.3.32", "formula-002", 131, p131.f332),
