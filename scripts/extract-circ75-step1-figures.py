"""Extract official raster crops for Circolare 7/2019 C7.5."""
...
MANIFEST = ROOT / "corpus" / "assets" / "circ2019" / "7.5.json"
...
def main() -> None:
    ...
    print(f"circ75-step1-figures: extracted {len(manifest['figures'])} figures")
