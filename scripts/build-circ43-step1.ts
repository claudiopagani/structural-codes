...
const formulas = [
    f("4.3.1", "C4.3.4.2", 148, "M_{Rd}=M_{pl,a,Rd}+(M_{pl,Rd}-M_{pl,a,Rd})\\cdot\\eta"),
    f("4.3.2", "C4.3.4.3.1.2", 150, "\\frac{F_l^2}{P_{l,Rd}^2}+\\frac{F_t^2}{P_{t,Rd}^2}\\le1,0"),
    f("4.3.3", "C4.3.4.3.3", 150, "V_{ld}=F_{cf}=\\min\\left\\{\\frac{A_a\\cdot f_{yk}}{\\gamma_a};0{,}85\\frac{f_{ck}\\cdot A_c}{\\gamma_c}+\\frac{A_{se}\\cdot f_{sk}}{\\gamma_s}\\right\\}"),
    f("4.3.4", "C4.3.4.3.3", 150, "V_{ld}=F_{cf}+\\frac{A_s\\cdot f_{sk}}{\\gamma_s}+\\frac{A_{ap}\\cdot f_{yp}}{\\gamma_{ap}}=\\min\\left\\{\\frac{A_a\\cdot f_{yk}}{\\gamma_a};0{,}85\\frac{f_{ck}\\cdot A_c}{\\gamma_c}+\\frac{A_{se}\\cdot f_{sk}}{\\gamma_s}\\right\\}+\\frac{A_s\\cdot f_{sk}}{\\gamma_s}+\\frac{A_{ap}\\cdot f_{yp}}{\\gamma_{ap}}"),
    f("4.3.5", "C4.3.4.3.3", 151, "V_{ld}=F_c=\\eta\\times F_{cf}=\\frac{M_{Rd}-M_{a,pl,Rd}}{M_{pl,Rd}-M_{a,pl,Rd}}\\times F_{cf}"),
    f("4.3.6", "C4.3.4.3.3", 151, "V_{ld}=F_c+\\frac{A_s\\cdot f_{sk}}{\\gamma_s}+\\frac{A_{ap}\\cdot f_{yp}}{\\gamma_{ap}}"),
    f("4.3.7", "C4.3.4.3.5", 151, "v_{Ed}=\\frac{\\Delta F_s}{\\Delta x\\cdot h_f}"),
    f("4.3.8", "C4.3.4.3.5", 151, "\\frac{A_{sf}\\cdot f_{sk}}{\\gamma_s\\cdot s_f}\\ge v_{Ed}\\cdot h_f"),
    f("4.3.9", "C4.3.4.3.5", 151, "v_{Ed}\\le0{,}3\\left[1-\\frac{f_{ck}}{250}\\right]\\cdot\\frac{f_{ck}}{\\gamma_c}"),
    f("4.3.10", "C4.3.4.3.6", 152, "M_{b,Rd}=\\chi_{LT}\\cdot M_{Rd}"),
    f("4.3.11", "C4.3.4.3.6", 152, "\\lambda_{LT}=\\sqrt{\\frac{M_{Rk}}{M_{cr}}}"),
    f("4.3.12", "C4.3.4.3.6", 152, "k_s=\\frac{1}{k_1}+\\frac{1}{k_2}"),
    f("4.3.13", "C4.3.4.3.6", 152, "k_2=\\frac{E_a\\cdot t_w^3}{4(1-\\nu^2)\\cdot h_s}"),
];
