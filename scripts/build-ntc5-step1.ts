...
const assetManifest = {
    ...
    figures: [
        ...
        { id: asset("figure", "5.1.2"), unitId: "urn:structural-codes:it:unit:ntc2018:5.1.3.3.5", officialNumber: "5.1.2", pdfPage: 157, caption: "Fig. 5.1.2 - Schemi di carico 1 – 5 (dimensioni in m)", captionInline: [{ kind: "text", value: "Fig. 5.1.2 - " }, { kind: "em", value: "Schemi di carico 1 – 5 (dimensioni in " }, { kind: "math", value: "m", latex: "\\mathrm{m}" }, { kind: "em", value: ")" }], alt: "Schemi di carico da 1 a 5 per ponti stradali", imagePath: "figures/ntc2018/fig5.1.2.png", region: { coordinateSystem: "pdf-points-top-left", x: 65, y: 345, width: 465, height: 320 }, sha256: "" },
        { id: asset("figure", "5.1.3.a"), unitId: "urn:structural-codes:it:unit:ntc2018:5.1.3.3.6", officialNumber: "5.1.3.a", pdfPage: 158, caption: "Fig. 5.1.3.a - Diffusione dei carichi concentrati nelle solette", alt: "Diffusione dei carichi concentrati nelle solette", imagePath: "figures/ntc2018/fig5.1.3.a.png", region: { coordinateSystem: "pdf-points-top-left", x: 75, y: 455, width: 260, height: 82.5 }, sha256: "" },
        { id: asset("figure", "5.1.3.b"), unitId: "urn:structural-codes:it:unit:ntc2018:5.1.3.3.6", officialNumber: "5.1.3.b", pdfPage: 158, caption: "Fig. 5.1.3.b - Diffusione dei carichi concentrati negli impalcati a piastra ortotropa", alt: "Diffusione dei carichi concentrati negli impalcati a piastra ortotropa", imagePath: "figures/ntc2018/fig5.1.3.b.png", region: { coordinateSystem: "pdf-points-top-left", x: 335, y: 455, width: 125, height: 80 }, sha256: "" },
    ],
};
