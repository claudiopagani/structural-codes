"""Extract the six official figures of Circolare 2019 C7.4."""
...
MANIFEST = ROOT / "corpus/assets/circ2019/7.4.json"
...
def main() -> None:
    ...
    for figure in manifest["figures"]:
        ...
        subprocess.run([
            str(PDFTOPPM), "-f", str(figure["pdfPage"]),
            "-l", str(figure["pdfPage"]), "-r", "300", "-png", "-singlefile",
    ...
    print(f"circ74-figures: extracted {len(manifest['figures'])} figures")
