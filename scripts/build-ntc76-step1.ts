...
const units: UnitSpec[] = [
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 252, from: 23, to: 25 },
        ],
    },
    {
        number: "7.6.2.2",
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 253, from: 17, to: 21 },
            formula("7.6.2", 253, 22, 23, "V_{wp,Rd}=0{,}8(V_{wp,s,Rd}+V_{wp,c,Rd})"),
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 253, from: 33 },
            ...
            { kind: "paragraph", page: 253, from: 38, normalized: "La duttilità locale è definita come segue:" },
            formula("7.6.4.3:mu-local", 253, 38, 38, "\\mu=q_u/q_y"),
    ...
    },
    {
        ...
        blocks: [
            { kind: "paragraph", page: 254, from: 26, to: 28 },
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 255, from: 10, to: 12 },
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 255, from: 42, to: 46, normalized: "L’adozione dei dettagli d’armatura trasversale riportati in Fig. 7.6.1 può ritardare l’innesco dei fenomeni di instabilità locale nelle zone dissipative. In particolare i limiti riportati in Tab. 7.6.I per le piattabande possono essere incrementati se tali barre sono caratterizzate da un interasse longitudinale, s_l, minore della lunghezza netta, c, della piattabanda, s_l/c < 1,0:", math: [m("s_l", "s_l"), math.c] },
            { kind: "list-item", page: 255, from: 47, to: 48, normalized: "per s_l/c ≤ 0,5, i limiti di Tab. 7.6.I possono essere moltiplicati per un coefficiente 1,50;", math: [m("s_l/c", "s_l/c")] },
            { kind: "list-item", page: 255, from: 49, to: 51, normalized: "per 0,5 < s_l/c < 1,0 si può interpolare linearmente tra i coefficienti 1,50 e 1,00.", math: [m("s_l/c", "s_l/c")] },
            { kind: "paragraph", page: 255, from: 52 },
    ...
    },
    {
        ...
        blocks: [
            ...
            formula("7.6.8", 257, 40, 41, "\\sum M_{C,pl,Rd}\\ge\\gamma_{Rd}\\sum M_{b,pl,Rd}"),
    ...
    },
    {
        ...
        blocks: [
            { kind: "paragraph", page: 257, from: 50, to: 53, math: [math.beff] },
...
const formulaLatex: Record<string, { unit: string; number: string | null; page: number; latex: string }> = {
    ...
    "7.6.2": { unit: "7.6.4.2", number: "7.6.2", page: 253, latex: "V_{wp,Rd}=0{,}8(V_{wp,s,Rd}+V_{wp,c,Rd})" },
    "7.6.3": { unit: "7.6.4.3", number: "7.6.3", page: 253, latex: "\\frac{N_{Ed}}{N_{pl,Rd}}\\le0{,}3" },
    "7.6.4.3:mu-local": { unit: "7.6.4.3", number: null, page: 253, latex: "\\mu=q_u/q_y" },
    "7.6.4": { unit: "7.6.5.1", number: "7.6.4", page: 255, latex: "b_{eff}=b_{e1}+b_{e2}+b_c" },
    "7.6.5": { unit: "7.6.5.1", number: "7.6.5", page: 255, latex: "\\frac{x}{d}<\\frac{\\varepsilon_{cu}}{\\varepsilon_{cu}+\\varepsilon_a}" },
    "7.6.6": { unit: "7.6.6.1", number: "7.6.6", page: 257, latex: "I_{eq}=0{,}6I_1+0{,}4I_2" },
    "7.6.7": { unit: "7.6.6.1", number: "7.6.7", page: 257, latex: "(E\\cdot I)_C=0{,}9(E\\cdot I_a+r\\cdot E_{cm}\\cdot I_c+E\\cdot I_s)" },
    "7.6.8": { unit: "7.6.6.2", number: "7.6.8", page: 257, latex: "\\sum M_{C,pl,Rd}\\ge\\gamma_{Rd}\\sum M_{b,pl,Rd}" },
};
...
const tables = [
    ...
    },
    {
        ...
        rows: [
            ...
            [cell("Positivo, M^+", "\\text{Positivo, }M^+"), cell("Colonna esterna"), cell("Trave trasversale assente o priva di connettori; Soletta disposta in modo da raggiungere o superare il filo esterno della colonna disposta in asse forte"), cell("bmagg/2 + 0,7 hc/2", "\\frac{b_{magg}}2+0{,}7\\frac{h_c}2")],
            [cell("Positivo, M^+", "\\text{Positivo, }M^+"), cell("Colonna esterna"), cell("Disposizioni differenti"), cell("bmagg/2 ≤ 0,05 L", "\\frac{b_{magg}}2\\le0{,}05L")],
        ],
        notes: ["Tabella strutturata dal render ufficiale; revisione umana cella per cella ancora obbligatoria."],
    },
];
...
const figures = [
    {
        ...
        pdfPage: 254,
        caption: "Fig. 7.6.1 - Dettagli costruttivi delle colonne composte rivestite di calcestruzzo",
        alt: "Fig. 7.6.1 con le sezioni e i dettagli costruttivi delle colonne composte rivestite di calcestruzzo.",
