...
function figureBlock(suffix: string, asset: string, page: number, caption: string, region: Region, captionCropped = false): GeneratedBlock { const record = evidence(page, caption, caption, region, true); if (captionCropped) record.transformations.push({ operation: "manual-correction", ruleVersion: "figure-caption-crop-0.1.0", note: "Esclusa dal ritaglio raster la didascalia, resa separatamente dal viewer." }); return { blockId: `${uid(unitNumber)}#block-${suffix}`, kind: "figure-ref", origin: "official", assetId: asset, evidence: record }; }
...
const formula105: FormulaRow = { number: "C4.2.105", page: 138, latex: "\\sigma_{cr,s}=2\\cdot\\frac{\\sqrt{k\\cdot E\\cdot I_s}}{A_s}", raw: "σ_cr,s = 2 · √(k·E·I_s)/A_s [C4.2.105]", region: reg(145, 300, 325, 45) };
...
const formula108: FormulaRow = { number: "C4.2.108", page: 138, latex: "\\begin{aligned}\\chi_d&=1&&\\text{per }\\lambda_d<0{,}65\\\\\\chi_d&=1{,}47-0{,}723\\cdot\\lambda_d&&\\text{per }0{,}65\\le\\lambda_d\\le1{,}38\\\\\\chi_d&=\\frac{0{,}66}{\\lambda_d}&&\\text{per }\\lambda_d>1{,}38\\end{aligned}", raw: "χ_d = 1 per λ_d < 0,65; χ_d = 1,47 − 0,723·λ_d per 0,65 ≤ λ_d ≤ 1,38; χ_d = 0,66/λ_d per λ_d > 1,38 [C4.2.108]", region: reg(145, 430, 325, 75) };
const formula109: FormulaRow = { number: "C4.2.109", page: 138, latex: "\\sigma_{com,Ed,i}=\\chi_d\\cdot\\frac{f_{yk}}{\\gamma_{M0}}", raw: "σ_com,Ed,i = χ_d · f_yk/γ_M0 [C4.2.109]", region: reg(145, 560, 325, 45) };
...
const formula111: FormulaRow = { number: "C4.2.111", page: 138, latex: "A_{s,rid}=\\frac{\\chi_d\\cdot f_{yk}\\cdot A_s}{\\gamma_{M0}\\cdot\\sigma_{com,Ed}}", raw: "A_s,rid = χ_d · f_yk · A_s/(γ_M0 · σ_com,Ed) [C4.2.111]", region: reg(145, 690, 325, 45) };
const formula112: FormulaRow = { number: "C4.2.112", page: 139, latex: "t_{rid}=t\\cdot\\frac{A_{s,rid}}{A_s}", raw: "t_rid = t · A_s,rid/A_s [C4.2.112]", region: reg(145, 50, 325, 70) };
...
const figure27Region = reg(70, 570, 455, 143);
const figure28Region = reg(130, 140, 330, 200);
const figure29Region = reg(180, 480, 260, 70);
const figure30Region = reg(180, 582, 260, 48);
...
const blocks: GeneratedBlock[] = [
    ...
    figureBlock("figure-27", figure27, 136, "Figura C4.2.27 – Esempi di determinazione della larghezza b_p", figure27Region, true),
    ...
    figureBlock("figure-28", figure28, 137, "Figura C4.2.28 – Modelli statici per diverse tipologie di elementi piani", figure28Region, true),
    ...
    figureBlock("figure-29", figure29, 137, "Figura C4.2.29 – Elementi piani delimitati da un’anima e da un irrigidimento di bordo", figure29Region, true),
    figureBlock("figure-30", figure30, 137, "Figura C4.2.30 – Elementi piani delimitati da due anime con irrigidimenti intermedi", figure30Region, true),
...
const figureRows = [
    ...
    [figure27, "C4.2.27", "Figura C4.2.27 – Esempi di determinazione della larghezza b_p", "Esempi di determinazione della larghezza b_p", figure27Region, "page-0136-x70-y570-w455-h143@4x.png", "6c73368e6d919b066fbe69596230754fb931e5bf2af14d65704d4282ae6e0edf"],
    [figure28, "C4.2.28", "Figura C4.2.28 – Modelli statici per diverse tipologie di elementi piani", "Modelli statici per diverse tipologie di elementi piani", figure28Region, "page-0137-x130-y140-w330-h200@4x.png", "b07a17af17c202704fb3ba3085d2428111c7ac3120d09aebe863c9878a2c58a6"],
    [figure29, "C4.2.29", "Figura C4.2.29 – Elementi piani delimitati da un’anima e da un irrigidimento di bordo", "Elementi piani delimitati da un’anima e da un irrigidimento di bordo", figure29Region, "page-0137-x180-y480-w260-h70@4x.png", "bebe36a69a464fed17fa30c0c82b22d5c92869e4576bf3b0d59950f36397a65c"],
    [figure30, "C4.2.30", "Figura C4.2.30 – Elementi piani delimitati da due anime con irrigidimenti intermedi", "Elementi piani delimitati da due anime con irrigidimenti intermedi", figure30Region, "page-0137-x180-y582-w260-h48@4x.png", "99340d6e962bb029736646a6eda786a7bc22b2cafe952f072f22c328c6543050"],
