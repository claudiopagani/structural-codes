...
const formula142: FormulaRow = { number: "C4.2.142", page: 144, latex: "F_{b,Rd}=\\frac{3{,}2\\cdot f_{tk}\\cdot d\\cdot t}{\\gamma_{M2}}", raw: "F_b,Rd = 3,2·f_tk·d·t/γ_M2 [C4.2.142]", region: reg(145, 170, 325, 45) };
const formula143: FormulaRow = { number: "C4.2.143", page: 144, latex: "F_{n,Rd}=\\frac{A_{net}\\cdot f_{tk}}{\\gamma_{M2}}", raw: "F_n,Rd = A_net·f_tk/γ_M2 [C4.2.143]", region: reg(145, 215, 325, 45) };
const formula144: FormulaRow = { number: "C4.2.144", page: 144, latex: "F_{p,Rd}=\\frac{f_{tk}\\cdot d_w\\cdot t}{\\gamma_{M2}}", raw: "F_p,Rd = f_tk·d_w·t/γ_M2 [C4.2.144]", region: reg(145, 255, 325, 45) };
...
const formula146: FormulaRow = { number: "C4.2.146", page: 144, latex: "\\begin{aligned}&e_1\\ge4{,}5\\cdot d\\ ;\\quad p_1\\ge4{,}5\\cdot d\\ ;\\quad e_2\\ge4{,}5\\cdot d\\ ;\\quad p_2\\ge4{,}5\\cdot d\\\\&\\text{per }d=3{,}7\\,\\mathrm{mm}:t^*\\ge4\\,\\mathrm{mm};\\quad\\text{per }d=4{,}5\\,\\mathrm{mm}:t^*\\ge6\\,\\mathrm{mm};\\quad\\text{per }d=5{,}2\\,\\mathrm{mm}:t^*\\ge8\\,\\mathrm{mm}\\end{aligned}", raw: "e_1 ≥ 4,5·d; p_1 ≥ 4,5·d; e_2 ≥ 4,5·d; p_2 ≥ 4,5·d; per d=3,7 mm t*≥4 mm; per d=4,5 mm t*≥6 mm; per d=5,2 mm t*≥8 mm [C4.2.146]", region: reg(145, 335, 325, 65) };
...
const manifest = { $schema: "urn:structural-codes:schema:asset-manifest:v2", schemaVersion: "2.0.0-alpha.2", recordType: "asset-manifest", document: "circ2019", section: "C4.2-step2aa", sourceId, status: "draft", formulas: formulaRows.map((formula) => ({ id: formulaId(formula.number), unitId: uid(unit731), officialNumber: formula.number, pdfPage: formula.page, latex: formula.latex })), tables: [], figures: [] };
