...
const tableAsset = {
    ...
    columnCount: 5,
    headers: [[
        { text: "Classe della sezione", align: "left" },
        { text: "1", align: "center" },
        { text: "2", align: "center" },
        { text: "3", align: "center" },
        { text: "4", align: "center" },
    ...
    rows: [
        [{ text: "“Analisi non-fessurata”", align: "left" }, { text: "40", align: "center" }, { text: "30", align: "center" }, { text: "20", align: "center" }, { text: "10", align: "center" }],
        [{ text: "“Analisi fessurata”", align: "left" }, { text: "25", align: "center" }, { text: "15", align: "center" }, { text: "10", align: "center" }, { text: "0", align: "center" }],
    ],
...
const figureAssets = [
    {
        ...
        pdfPage: 121,
        caption: "Fig. 4.3.1. - Definizione della larghezza efficace b_eff e delle aliquote b_ei",
        captionInline: [
            { kind: "strong", value: "Fig. 4.3.1. - " },
            { kind: "em", value: "Definizione della larghezza efficace " },
            { kind: "math", value: "b_eff", latex: "b_{\\mathrm{eff}}" },
            { kind: "em", value: " e delle aliquote " },
            { kind: "math", value: "b_ei", latex: "b_{ei}" },
        ],
    ...
    },
    {
        ...
        pdfPage: 122,
        caption: "Fig. 4.3.2 - Larghezza efficace, b_eff, e luci equivalenti, L_e, per le travi continue",
        captionInline: [
            { kind: "strong", value: "Fig. 4.3.2 - " },
            { kind: "em", value: "Larghezza efficace, " },
            { kind: "math", value: "b_eff", latex: "b_{\\mathrm{eff}}" },
            { kind: "em", value: ", e luci equivalenti, " },
            { kind: "math", value: "L_e", latex: "L_e" },
            { kind: "em", value: ", per le travi continue" },
        ],
...
for (const asset of figureAssets) {
    ...
    manifest.figures.push({
        ...
        captionInline: asset.captionInline,
        alt: asset.alt,
