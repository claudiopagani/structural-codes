...
const formulaRows: FormulaRow[] = [
    { number: "C4.2.62", unit: "C4.2.4.1.3.4.3", page: 117, latex: "b_{\\mathrm{eff}}=\\beta\\,b_0", raw: "b_eff = β · b_0 [C4.2.62]", region: reg(145, 165, 310, 60) },
    ...
    { number: "C4.2.65", unit: "C4.2.4.1.3.4.3", page: 118, latex: "A_{\\mathrm{eff}}=\\beta^\\kappa\\,A_{c,\\mathrm{eff}}\\ge\\beta\\,A_{c,\\mathrm{eff}}", raw: "A_eff = β^κ · A_c,eff ≥ β · A_c,eff [C4.2.65]", region: reg(145, 345, 310, 60) },
];
...
const units = [
    makeUnit("C4.2.4.1.3.4.3", "Larghezza collaborante", [
        ...
        block("C4.2.4.1.3.4.3", "p3", "paragraph", 117, "essendo β il fattore riduttivo dato nella Tabella C4.2.X in funzione di κ=α_0·b_0/L_e.", [text("essendo "), math("β", "\\beta"), text(" il fattore riduttivo dato nella Tabella C4.2.X in funzione di "), math("κ=α_0·b_0/L_e", "\\kappa=\\alpha_0\\,b_0/L_e"), text(".")]),
