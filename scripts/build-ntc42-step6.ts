...
const continuationBlocks = [
  ...
  textBlock("4.2.8.1.1", "p22-intro", "paragraph", p115, reg(82.954, 278.358, 40, 8), "dove:"),
  textBlock("4.2.8.1.1", "p22-d", "paragraph", p115, reg(82.954, 291, 300, 8), "d è il diametro nominale del gambo del bullone,", [m("d", "d"), t(" è il diametro nominale del gambo del bullone,")]),
  textBlock("4.2.8.1.1", "p22-t", "paragraph", p115, reg(82.954, 304, 280, 8), "t è lo spessore della piastra collegata,", [m("t", "t"), t(" è lo spessore della piastra collegata,")]),
  textBlock("4.2.8.1.1", "p22-ftk", "paragraph", p115, reg(82.954, 317, 390, 8), "ftk è la resistenza caratteristica a rottura del materiale della piastra collegata,", [m("ftk", "f_{tk}"), t(" è la resistenza caratteristica a rottura del materiale della piastra collegata,")]),
  textBlock("4.2.8.1.1", "p22-alpha-edge", "paragraph", p115, reg(82.954, 330, 428.6, 8), "α=min {e1/(3 d0) ; ftbk/ftk ; 1} per bulloni di bordo nella direzione del carico applicato,", [m("α=min {e1/(3 d0) ; ftbk/ftk ; 1}", "\\alpha=\\min\\{e_1/(3d_0);f_{tbk}/f_{tk};1\\}"), t(" per bulloni di bordo nella direzione del carico applicato,")]),
  textBlock("4.2.8.1.1", "p22-alpha-inner", "paragraph", p115, reg(82.954, 343, 428.6, 8), "α=min {p1/(3 d0) − 0,25 ; ftbk/ftk ; 1} per bulloni interni nella direzione del carico applicato,", [m("α=min {p1/(3 d0) − 0,25 ; ftbk/ftk ; 1}", "\\alpha=\\min\\{p_1/(3d_0)-0{,}25;f_{tbk}/f_{tk};1\\}"), t(" per bulloni interni nella direzione del carico applicato,")]),
  textBlock("4.2.8.1.1", "p22-k-edge", "paragraph", p115, reg(82.954, 356, 428.6, 8), "k=min {2,8 e2/d0 − 1,7 ; 2,5} per bulloni di bordo nella direzione perpendicolare al carico applicato,", [m("k=min {2,8 e2/d0 − 1,7 ; 2,5}", "k=\\min\\{2{,}8e_2/d_0-1{,}7;2{,}5\\}"), t(" per bulloni di bordo nella direzione perpendicolare al carico applicato,")]),
  textBlock("4.2.8.1.1", "p22-k-inner", "paragraph", p115, reg(82.954, 369, 428.6, 20), "k=min {1,4 p2/d0 − 1,7 ; 2,5} per bulloni interni nella direzione perpendicolare al carico applicato, essendo e1, e2, p1 e p2 indicati in Fig. 4.2.5 e d0 il diametro nominale del foro di alloggiamento del bullone.", [m("k=min {1,4 p2/d0 − 1,7 ; 2,5}", "k=\\min\\{1{,}4p_2/d_0-1{,}7;2{,}5\\}"), t(" per bulloni interni nella direzione perpendicolare al carico applicato, essendo "), m("e1, e2, p1 e p2", "e_1,e_2,p_1,p_2"), t(" indicati in Fig. 4.2.5 e "), m("d0", "d_0"), t(" il diametro nominale del foro di alloggiamento del bullone.")]),
  ...
  textBlock("4.2.8.1.1", "p30", "paragraph", p115, reg(82.958, 631.416, 428.6, 54), "dove: n è il numero delle superfici di attrito, μ è il coefficiente di attrito, Fp,Cd è la forza di precarico del bullone data dalla espressione [4.2.62] che, in caso di serraggio controllato, può essere assunta pari a 0,7 ftbk Ares, invece che pari a 0,7 ftbk Ares/γM7.", [t("dove: "), m("n", "n"), t(" è il numero delle superfici di attrito, "), m("μ", "\\mu"), t(" è il coefficiente di attrito, "), m("Fp,Cd", "F_{p,Cd}"), t(" è la forza di precarico del bullone data dalla espressione [4.2.62] che, in caso di serraggio controllato, può essere assunta pari a "), m("0,7 ftbk Ares", "0{,}7f_{tbk}A_{res}"), t(", invece che pari a "), m("0,7 ftbk Ares/γM7", "0{,}7f_{tbk}A_{res}/\\gamma_{M7}"), t(".")]),
  textBlock("4.2.8.1.1", "p30-friction-intro", "paragraph", p116, reg(82.954, 98, 428.6, 8), "Il coefficiente di attrito tra le piastre μ a contatto nelle unioni “precaricate” è in genere assunto pari a:", [t("Il coefficiente di attrito tra le piastre "), m("μ", "\\mu"), t(" a contatto nelle unioni “precaricate” è in genere assunto pari a:")]),
  textBlock("4.2.8.1.1", "friction-mu-05", "paragraph", p116, reg(155, 112, 350, 28), "μ = 0,5 – superfici sabbiate meccanicamente o a graniglia, esenti da incrostazioni di ruggine e da vaiolature;", [m("μ = 0,5", "\\mu=0{,}5"), t(" – superfici sabbiate meccanicamente o a graniglia, esenti da incrostazioni di ruggine e da vaiolature;")]),
  textBlock("4.2.8.1.1", "friction-mu-04-a", "paragraph", p116, reg(155, 142, 350, 28), "μ = 0,4 – superfici sabbiate meccanicamente o a graniglia, e verniciate a spruzzo con prodotti a base di alluminio o di zinco.", [m("μ = 0,4", "\\mu=0{,}4"), t(" – superfici sabbiate meccanicamente o a graniglia, e verniciate a spruzzo con prodotti a base di alluminio o di zinco.")]),
  textBlock("4.2.8.1.1", "friction-mu-04-b", "paragraph", p116, reg(205, 171, 300, 28), "– superfici sabbiate meccanicamente o a graniglia, e verniciate con silicato di zinco alcalino applicando uno spessore dello strato di 50-80 μm;", [t("– superfici sabbiate meccanicamente o a graniglia, e verniciate con silicato di zinco alcalino applicando uno spessore dello strato di 50-80 "), m("μm", "\\mu\\mathrm{m}"), t(";")]),
  textBlock("4.2.8.1.1", "friction-mu-03", "paragraph", p116, reg(155, 198, 350, 20), "μ = 0,3 – superfici pulite mediante spazzolatura o alla fiamma, esenti da incrostazioni di ruggine;", [m("μ = 0,3", "\\mu=0{,}3"), t(" – superfici pulite mediante spazzolatura o alla fiamma, esenti da incrostazioni di ruggine;")]),
  textBlock("4.2.8.1.1", "friction-mu-02", "paragraph", p116, reg(155, 220, 300, 8), "μ = 0,2 – superfici non trattate.", [m("μ = 0,2", "\\mu=0{,}2"), t(" – superfici non trattate.")]),
...
const units = [
  ...
  unit("4.2.9.1", "SPESSORI LIMITE", [
    ...
    textBlock("4.2.9.1", "p1", "paragraph", p118, reg(82.954, 501, 428.6, 7.48), "È vietato l’uso di profilati con spessore t < 4 mm.", [t("È vietato l’uso di profilati con spessore "), m("t < 4 mm", "t<4\\,\\mathrm{mm}"), t(".")]),
    textBlock("4.2.9.1", "p2", "paragraph", p118, reg(82.954, 514, 428.6, 27.6), "Una deroga a tale norma, fino ad uno spessore t = 3 mm, è consentita per opere sicuramente protette contro la corrosione, quali per esempio tubi chiusi alle estremità e profili zincati, od opere non esposte agli agenti atmosferici.", [t("Una deroga a tale norma, fino ad uno spessore "), m("t = 3 mm", "t=3\\,\\mathrm{mm}"), t(", è consentita per opere sicuramente protette contro la corrosione, quali per esempio tubi chiusi alle estremità e profili zincati, od opere non esposte agli agenti atmosferici.")]),
...
const formulaRows = [
  ...
  ["4.2.80", "4.2.8.1.2", 116, "\\sigma_{h,Ed}=0{,}591\\sqrt{\\frac{E\\cdot F_{Ed,ser}\\cdot(d_0-d)}{d^2\\cdot t}}"],
  ["4.2.81", "4.2.8.2.4", 117, "\\begin{aligned}\\left[\\sigma_{\\perp}^{2}+3\\left(\\tau_{\\perp}^{2}+\\tau_{\\parallel}^{2}\\right)\\right]^{0{,}5}&\\le f_{tk}/(\\beta\\gamma_{M2})\\\\\\sigma_{\\perp}&\\le0{,}9f_{tk}/\\gamma_{M2}\\end{aligned}"],
  ["4.2.82", "4.2.8.2.4", 117, "F_{w,Ed}/F_{w,Rd}\\le1"],
  ["4.2.83", "4.2.8.2.4", 118, "F_{w,Rd}=a f_{tk}/(\\sqrt{3}\\beta\\gamma_{M2})"],
  ["4.2.84", "4.2.8.2.4", 118, "\\sqrt{n_{\\perp}^{2}+t_{\\perp}^{2}+t_{\\parallel}^{2}}\\le\\beta_1\\cdot f_{yk}"],
  ["4.2.85", "4.2.8.2.4", 118, "|n_{\\perp}|+|t_{\\perp}|\\le\\beta_2\\cdot f_{yk}"],
] as const;
...
const continuationStart = existing.blocks.findIndex((block) => block.blockId.endsWith("#block-heading-shear-tension"));
const prefixEnd = continuationStart < 0 ? existing.blocks.length : continuationStart;
existing.blocks = [...existing.blocks.slice(0, prefixEnd), ...continuationBlocks];
