"""Extract official raster crops for Circolare 7/2019 C7.6."""
...
MANIFEST = ROOT / "corpus" / "assets" / "circ2019" / "7.6.json"
...
def main() -> None:
    ...
    print(f"circ76-step1-figures: extracted {len(manifest['figures'])} figures")
