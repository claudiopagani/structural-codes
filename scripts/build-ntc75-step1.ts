...
const units: UnitSpec[] = [
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 247, from: 51, normalized: "γ_ov è il fattore di sovraresistenza relativo al materiale di cui al § 7.5.1;", math: [math.gammaOv] },
            {
                ...
                math: [
                    math.omega,
                    m("Ω_i = (M_{pl,Rd,i} − M_{Ed,G,i}) / M_{Ed,E,i}", "\\Omega_i=(M_{pl,Rd,i}-M_{Ed,G,i})/M_{Ed,E,i}"),
    ...
    },
    {
        ...
        blocks: [
            ...
            { kind: "paragraph", page: 250, from: 15, to: 16, normalized: "Quando sia soddisfatta la relazione N_{Ed}/N_{pl,Rd} < 0,15 occorre che ad entrambe le estremità del collegamento la capacità a taglio ed a flessione siano maggiori della corrispondente domanda:", math: [m("N_{Ed}/N_{pl,Rd} < 0,15", "N_{Ed}/N_{pl,Rd}<0{,}15")] },
            ...
            { kind: "paragraph", page: 250, from: 36, normalized: "Se N_{Ed}/N_{pl,Rd} ≥ 0,15 occorre anche che sia:", math: [m("N_{Ed}/N_{pl,Rd} ≥ 0,15", "N_{Ed}/N_{pl,Rd}\\ge0{,}15")] },
            ...
            { kind: "paragraph", page: 250, from: 41, to: 42, normalized: "dove R = N_{Ed} t_w (d - 2t_f) / (V_{Ed} A), in cui A è l’area lorda del collegamento.", math: [m("R = N_{Ed} t_w (d - 2t_f) / (V_{Ed} A)", "R=N_{Ed}t_w(d-2t_f)/(V_{Ed}A)"), m("A", "A")] },
