...
function makeUnit(number: string, title: string, kind: "section" | "subparagraph", blocks: unknown[], figureIds: string[]) {
    return {
        ...
        workflow: { status: "extracted", createdBy: { actorId, kind: "automated-agent", toolVersion: profile }, createdAt, reviews: number === "4.3.5.5.1" ? [{ reviewId: "ntc2018-4-3-5-5-1-figure-typo-confirmation-01", type: "editorial", reviewer: { actorId: "reviewer:human:user-confirmation", kind: "human" }, reviewedAt: "2026-09-08T00:00:00Z", result: "accepted", note: "Confermata da revisore umano la didascalia «Fig. 4.3.9»; nel capoverso resta fedelmente «Fig. 4.3.-9», refuso della fonte." }] : [], openIssues: [
            ...
            ...(number === "4.3.5.5.1" ? [{ issueId: "ntc2018-4-3-5-5-1-source-typo", type: "other", severity: "warning", note: "La fonte stampa «Fig. 4.3.-9» nel capoverso, mentre la didascalia e il riferimento successivo stampano «Fig. 4.3.9»; refuso confermato da revisore umano e conservato fedelmente." }] : []),
        ] },
    };
}
...
const figureAssets = [
    { id: figureId("4.3.9"), unitId: unitId("4.3.5.5.1"), officialNumber: "4.3.9", pdfPage: 133, caption: "Fig. 4.3.9 -Disposizione dei pioli per la connessione meccanica acciaio-calcestruzzo", captionInline: [{ kind: "strong", value: "Fig. 4.3.9 -" }, { kind: "em", value: "Disposizione dei pioli per la connessione meccanica acciaio-calcestruzzo" }], alt: "Tre disposizioni di pioli a taglio tra ali di un profilo a doppio T, per una, due e tre o più file di connettori.", filename: "fig4.3.9.png", imagePath: "figures/ntc2018/fig4.3.9.png", region: p133.fig39 },
    { id: figureId("4.3.10"), unitId: unitId("4.3.5.6"), officialNumber: "4.3.10", pdfPage: 133, caption: "Fig. 4.3.10- Perimetro efficace delle barre di armatura.", captionInline: [{ kind: "strong", value: "Fig. 4.3.10- " }, { kind: "em", value: "Perimetro efficace delle barre di armatura." }], alt: "Schema del perimetro efficace di una barra di armatura adiacente al profilo.", filename: "fig4.3.10.png", imagePath: "figures/ntc2018/fig4.3.10.png", region: p133.fig310 },
    { id: figureId("4.3.11"), unitId: unitId("4.3.6"), officialNumber: "4.3.11", pdfPage: 134, caption: "Fig. 4.3.11 -Tipiche forme di connessione per ingranamento delle solette composte", captionInline: [{ kind: "strong", value: "Fig. 4.3.11 -" }, { kind: "em", value: "Tipiche forme di connessione per ingranamento delle solette composte" }], alt: "Quattro schemi di forme di connessione per ingranamento, identificate con (a), (b), (c) e (d).", filename: "fig4.3.11.png", imagePath: "figures/ntc2018/fig4.3.11.png", region: p134.fig311 },
    { id: figureId("4.3.12"), unitId: unitId("4.3.6.1.1"), officialNumber: "4.3.12", pdfPage: 134, caption: "Fig. 4.3.12 - Diffusione del carico concentrato", captionInline: [{ kind: "strong", value: "Fig. 4.3.12 - " }, { kind: "em", value: "Diffusione del carico concentrato" }], alt: "Diffusione a 45 gradi di un carico concentrato attraverso una soletta con lamiera grecata.", filename: "fig4.3.12.png", imagePath: "figures/ntc2018/fig4.3.12.png", region: p134.fig312 },
];
