...
const formulaAssets = [
    { id: formulaId("4.3.35"), unitId: unitId("4.3.5.4.3"), officialNumber: "4.3.35", pdfPage: 132, latex: "M_{Ed}\\le\\alpha_M\\,M_{pl,Rd}(N_{Ed})" },
    { id: formulaId("4.3.36"), unitId: unitId("4.3.5.4.3"), officialNumber: "4.3.36", pdfPage: 132, latex: "k=\\frac{\\beta}{1-N_{Ed}/N_{cr}}\\ge1,0" },
    { id: formulaId("4.3.37"), unitId: unitId("4.3.5.4.3"), officialNumber: "4.3.37", pdfPage: 132, latex: "\\beta=0,66+0,44\\,\\frac{M_{min}}{M_{max}}\\ge0,44" },
...
const units = [
    ...
    makeUnit("4.3.6.3.2", "Verifiche di deformazione", "subparagraph", [
        ...
        textBlock("4.3.6.3.2", "p-001", "paragraph", 135, p135.p3632a, "L’effetto dello scorrimento di estremità può essere trascurato se nei risultati sperimentali il carico che causa uno scorrimento di 0,5 mm è maggiore di 1,2 volte il carico della combinazione caratteristica considerata, oppure se la tensione tangenziale di scorrimento all’interfaccia è inferiore al 30% della tensione limite di aderenza Θ_u,Rd.", [t("L’effetto dello scorrimento di estremità può essere trascurato se nei risultati sperimentali il carico che causa uno scorrimento di "), m("0,5 mm", "0,5\\,\\mathrm{mm}"), t(" è maggiore di "), m("1,2", "1,2"), t(" volte il carico della combinazione caratteristica considerata, oppure se la tensione tangenziale di scorrimento all’interfaccia è inferiore al "), m("30%", "30\\%"), t(" della tensione limite di aderenza "), m("Θ_u,Rd", "\\Theta_{u,Rd}"), t(".")]),
