...
const table72 = {
    ...
    rows: [
        ...
        [cell("Acciaio", undefined, { rowSpan: 2 }), cell("Si impiega il fattore di sovraresistenza γ_ov definito al § 7.5.1", "\\text{Si impiega il fattore di sovraresistenza }\\gamma_{ov}\\text{ definito al }\\S\\,7.5.1", { colSpan: 4 })],
        [cell("Colonne (§ 7.5.4.2)"), cell("Pressoflessione [7.5.10]"), cell("1,30"), cell("1,30")],
        [cell("Composta acciaio-calcestruzzo", undefined, { rowSpan: 2 }), cell("Si impiega il fattore di sovraresistenza γ_ov definito al § 7.5.1", "\\text{Si impiega il fattore di sovraresistenza }\\gamma_{ov}\\text{ definito al }\\S\\,7.5.1", { colSpan: 4 })],
        [cell("Colonne (§ 7.6.6.2)"), cell("Pressoflessione [7.6.7]"), cell("1,30"), cell("1,30")],
        [cell("Legno"), cell("Collegamenti"), cell(""), cell("1,60"), cell("1,30")],
        [cell("Muratura armata con progettazione in capacità"), cell("Pannelli murari (§ 7.8.1.7)"), cell("Taglio"), cell("1,50", undefined, { colSpan: 2 })],
...
const table73 = {
    ...
    rows: [
        [cell("SLE", undefined, { rowSpan: 2 }), cell("SLO"), cell("q = 1.0\n§ 3.2.3.4", "\\begin{gathered}q=1.0\\\\\\S\\,3.2.3.4\\end{gathered}"), cell("q = 1.0\n§ 3.2.3.4", "\\begin{gathered}q=1.0\\\\\\S\\,3.2.3.4\\end{gathered}"), cell("§ 7.3.4.1", undefined, { rowSpan: 4 }), cell("§ 7.3.4.2", undefined, { rowSpan: 4 })],
        [cell("SLD"), cell("q ≤ 1,5\n§ 3.2.3.5", "\\begin{gathered}q\\le1{,}5\\\\\\S\\,3.2.3.5\\end{gathered}"), cell("q ≤ 1,5\n§ 3.2.3.5", "\\begin{gathered}q\\le1{,}5\\\\\\S\\,3.2.3.5\\end{gathered}")],
        [cell("SLU", undefined, { rowSpan: 2 }), cell("SLV"), cell("q ≥ 1,5\n§ 3.2.3.5", "\\begin{gathered}q\\ge1{,}5\\\\\\S\\,3.2.3.5\\end{gathered}"), cell("q ≤ 1,5\n§ 3.2.3.5", "\\begin{gathered}q\\le1{,}5\\\\\\S\\,3.2.3.5\\end{gathered}")],
        [cell("SLC"), cell("---"), cell("---")],
    ],
    notes: [],
};
...
const units = [
    ...
    makeUnit("7.2.3", "CRITERI DI PROGETTAZIONE DI ELEMENTI STRUTTURALI SECONDARI ED ELEMENTI COSTRUTTIVI NON STRUTTURALI", "subparagraph", [
        ...
        formulaBlock("7.2.3", fFa, 216, "7.2.1", "F_a=\\frac{S_a\\cdot W_a}{q_a}", reg(170, 438, 260, 30)),
    ...
    makeUnit("7.2.4", "CRITERI DI PROGETTAZIONE DEGLI IMPIANTI", "subparagraph", [
        ...
        block("7.2.4", "p5", "paragraph", [[217, 13, 16]], "Gli impianti non possono essere vincolati alla costruzione contando sull’effetto dell’attrito, bensì devono essere collegati ad essa con dispositivi di vincolo rigidi o flessibili; gli impianti a dispositivi di vincolo flessibili sono quelli che hanno periodo di vibrazione T ≥ 0,1s valutato tenendo conto della sola deformabilità del vincolo. Se si adottano dispositivi di vincolo flessibili, i collegamenti di servizio dell’impianto devono essere flessibili e non possono far parte del meccanismo di vincolo.", { manual: true, inline: inlineTerms("Gli impianti non possono essere vincolati alla costruzione contando sull’effetto dell’attrito, bensì devono essere collegati ad essa con dispositivi di vincolo rigidi o flessibili; gli impianti a dispositivi di vincolo flessibili sono quelli che hanno periodo di vibrazione T ≥ 0,1s valutato tenendo conto della sola deformabilità del vincolo. Se si adottano dispositivi di vincolo flessibili, i collegamenti di servizio dell’impianto devono essere flessibili e non possono far parte del meccanismo di vincolo.", [["T ≥ 0,1s", "T\\ge0{,}1\\,\\mathrm{s}"]]) }),
...
const formulaRows = [
    ...
    [fFa, "7.2.3", "7.2.1", "F_a=\\frac{S_a\\cdot W_a}{q_a}"],
