...
const expectedTableLatex = new Map<string, string[]>([
    ...
    ["4.2.III", ["c/t\\le72\\varepsilon", "c/t\\le33\\varepsilon", "\\text{quando }\\alpha>0{,}5:\\ c/t\\le\\frac{396\\varepsilon}{13\\alpha-1};\\quad\\text{quando }\\alpha\\le0{,}5:\\ c/t\\le\\frac{36\\varepsilon}{\\alpha}", "c/t\\le83\\varepsilon", "c/t\\le38\\varepsilon", "\\text{quando }\\alpha>0{,}5:\\ c/t\\le\\frac{456\\varepsilon}{13\\alpha-1};\\quad\\text{quando }\\alpha\\le0{,}5:\\ c/t\\le\\frac{41{,}5\\varepsilon}{\\alpha}", "c/t\\le124\\varepsilon", "c/t\\le42\\varepsilon", "\\text{quando }\\psi>-1:\\ c/t\\le\\frac{42\\varepsilon}{0{,}67+0{,}33\\psi};\\quad\\text{quando }\\psi\\le-1:\\ c/t\\le62\\varepsilon(1-\\psi)\\sqrt{-\\psi}", "\\varepsilon=\\sqrt{\\frac{235}{f_{yk}}}", "f_{yk}", "\\varepsilon"]],
    ...
    ["4.2.V", ["h/t\\le15\\varepsilon;\\quad\\frac{b+h}{2t}\\le11{,}5\\varepsilon", "d/t\\le50\\varepsilon^2", "d/t\\le70\\varepsilon^2", "d/t\\le90\\varepsilon^2\\quad(\\text{Per }d/t>90\\varepsilon^2\\text{ vedere EN 1993-1-6})", "\\varepsilon=\\sqrt{235/f_{yk}}", "f_{yk}", "\\varepsilon", "\\varepsilon^2"]],
    ["4.2.VI", []],
...
test("NTC pagine 92–101 conserva tutte le celle matematiche delle sette tabelle", async () => {
    ...
    for (const table of tables) {
        const latex = [...table.headers, ...table.rows, ...(table.footerRows ?? [])].flat().filter((cell: { latex?: string }) => cell.latex).map((cell: { latex: string }) => cell.latex);
