...
const expectedFormulas = new Map<string, string>([
    ...
    [formulaId("7.2.5-axial-a"), "\\pm 0{,}2\\,N_{Sd}\\,a_{max}/g\\quad\\text{per il profilo stratigrafico di tipo A}"],
    [formulaId("7.2.5-axial-b"), "\\pm 0{,}3\\,N_{Sd}\\,a_{max}/g\\quad\\text{per il profilo stratigrafico di tipo B}"],
    [formulaId("7.2.5-axial-c"), "\\pm 0{,}4\\,N_{Sd}\\,a_{max}/g\\quad\\text{per il profilo stratigrafico di tipo C}"],
    [formulaId("7.2.5-axial-d"), "\\pm 0{,}6\\,N_{Sd}\\,a_{max}/g\\quad\\text{per il profilo stratigrafico di tipo D}"],
