...
const expectedFormulas = new Map<string, string>([
    ...
    [formulaId("7.3.6.1-7.3.11a"), "q\\,d_r\\le0{,}0050\\cdot h\\quad\\text{per tamponature fragili}"],
    [formulaId("7.3.6.1-7.3.11b"), "q\\,d_r\\le0{,}0075\\cdot h\\quad\\text{per tamponature duttili}"],
