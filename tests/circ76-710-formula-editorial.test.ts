...
test("C8 pagine 287-295 conserva virgole, accenti e formule di consolidamento", async () => {
    const expected = new Map<string, string>([
        ...
        ["C8.7.2.11", "\\sigma_{jt}=\\left|\\frac{N}{2A_j}-\\sqrt{\\left(\\frac{N}{2A_j}\\right)^2+\\left(\\frac{V_j}{A_j}\\right)^2}\\right|\\le 0{,}3\\sqrt{f_c}\\,\\left(f_c\\,\\mathrm{in}\\,MPa\\right)"],
        ["C8.7.2.12", "\\sigma_{jc}=\\frac{N}{2A_j}+\\sqrt{\\left(\\frac{N}{2A_j}\\right)^2+\\left(\\frac{V_j}{A_j}\\right)^2}\\le 0{,}5f_c\\,\\left(f_c\\,\\mathrm{in}\\,MPa\\right)"],
